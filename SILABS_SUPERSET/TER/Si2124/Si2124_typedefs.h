...
/*************************************************************************************
   ...
   FILE: Si2124_typedefs.h
   Supported IC : Si2124
   Compiled for ROM 62 firmware 2_1_build_5
   Revision: 0.2
   Date: July 24 2017
**************************************************************************************/
#ifndef   Si2124_TYPEDEFS_H
#define   Si2124_TYPEDEFS_H
...
#define Si2124_BROADCAST_ADDRESS 0xc4

typedef struct L1_Si2124_Context {
  L0_Context                 *i2c;
  L0_Context                  i2cObj;
  Si2124_CmdObj              *cmd;
  Si2124_CmdObj               cmdObj;
  Si2124_CmdReplyObj         *rsp;
  Si2124_CmdReplyObj          rspObj;
  Si2124_PropObj             *prop;
  Si2124_PropObj              propObj;
  Si2124_PropObj             *propShadow;
  Si2124_PropObj              propShadowObj;
  Si2124_COMMON_REPLY_struct *status;
  Si2124_COMMON_REPLY_struct  statusObj;
  /* global variable for property settings mode
     Possible values:
         Si2124_DOWNLOAD_ON_CHANGE (recommended)
      or Si2124_DOWNLOAD_ALWAYS.                 */
