 ...
 ***********************************************************************************************************************/
unsigned char Si2176_L1_SetProperty(L1_Si2176_Context *api, unsigned int prop, int  data)  {
    unsigned char  reserved          = 0;
    return Si2176_L1_SET_PROPERTY (api, reserved, prop, data);
}
...
/***********************************************************************************************************************
  ...
  Returns:    0 if no error, an error code otherwise
 ***********************************************************************************************************************/
unsigned char    Si2176_L1_GetProperty(L1_Si2176_Context *api, unsigned int prop, int *data) {
    unsigned char  reserved          = 0;
    unsigned char res;
    res = Si2176_L1_GET_PROPERTY (api, reserved, prop);
...
/* _set_property2_insertion_start */
  ...
  /* --------------------------------------------*/
unsigned char Si2176_L1_SetProperty2(L1_Si2176_Context *api, unsigned int prop_code) {
    int data;
#ifdef    Si2176_GET_PROPERTY_STRING
    char msg[1000];
#endif /* Si2176_GET_PROPERTY_STRING */
    switch (prop_code) {
    #ifdef        Si2176_ATV_AFC_RANGE_PROP
     case         Si2176_ATV_AFC_RANGE_PROP_CODE:
       data = (api->prop->atv_afc_range.range_khz & Si2176_ATV_AFC_RANGE_PROP_RANGE_KHZ_MASK) << Si2176_ATV_AFC_RANGE_PROP_RANGE_KHZ_LSB ;
     break;
    #endif /*     Si2176_ATV_AFC_RANGE_PROP */
    #ifdef        Si2176_ATV_AF_OUT_PROP
     case         Si2176_ATV_AF_OUT_PROP_CODE:
       data = (api->prop->atv_af_out.volume & Si2176_ATV_AF_OUT_PROP_VOLUME_MASK) << Si2176_ATV_AF_OUT_PROP_VOLUME_LSB ;
     break;
    #endif /*     Si2176_ATV_AF_OUT_PROP */
    #ifdef        Si2176_ATV_AGC_SPEED_PROP
     case         Si2176_ATV_AGC_SPEED_PROP_CODE:
       data = (api->prop->atv_agc_speed.if_agc_speed & Si2176_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK) << Si2176_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB ;
     break;
    #endif /*     Si2176_ATV_AGC_SPEED_PROP */
    #ifdef        Si2176_ATV_AUDIO_MODE_PROP
     case         Si2176_ATV_AUDIO_MODE_PROP_CODE:
       data = (api->prop->atv_audio_mode.audio_sys  & Si2176_ATV_AUDIO_MODE_PROP_AUDIO_SYS_MASK ) << Si2176_ATV_AUDIO_MODE_PROP_AUDIO_SYS_LSB  |
              (api->prop->atv_audio_mode.demod_mode & Si2176_ATV_AUDIO_MODE_PROP_DEMOD_MODE_MASK) << Si2176_ATV_AUDIO_MODE_PROP_DEMOD_MODE_LSB  |
              (api->prop->atv_audio_mode.chan_bw    & Si2176_ATV_AUDIO_MODE_PROP_CHAN_BW_MASK   ) << Si2176_ATV_AUDIO_MODE_PROP_CHAN_BW_LSB ;
     break;
    #endif /*     Si2176_ATV_AUDIO_MODE_PROP */
    #ifdef        Si2176_ATV_CVBS_OUT_PROP
     case         Si2176_ATV_CVBS_OUT_PROP_CODE:
       data = (api->prop->atv_cvbs_out.offset & Si2176_ATV_CVBS_OUT_PROP_OFFSET_MASK) << Si2176_ATV_CVBS_OUT_PROP_OFFSET_LSB  |
              (api->prop->atv_cvbs_out.amp    & Si2176_ATV_CVBS_OUT_PROP_AMP_MASK   ) << Si2176_ATV_CVBS_OUT_PROP_AMP_LSB ;
     break;
    #endif /*     Si2176_ATV_CVBS_OUT_PROP */
    #ifdef        Si2176_ATV_CVBS_OUT_FINE_PROP
     case         Si2176_ATV_CVBS_OUT_FINE_PROP_CODE:
       data = (api->prop->atv_cvbs_out_fine.offset & Si2176_ATV_CVBS_OUT_FINE_PROP_OFFSET_MASK) << Si2176_ATV_CVBS_OUT_FINE_PROP_OFFSET_LSB  |
              (api->prop->atv_cvbs_out_fine.amp    & Si2176_ATV_CVBS_OUT_FINE_PROP_AMP_MASK   ) << Si2176_ATV_CVBS_OUT_FINE_PROP_AMP_LSB ;
     break;
    #endif /*     Si2176_ATV_CVBS_OUT_FINE_PROP */
    #ifdef        Si2176_ATV_IEN_PROP
     case         Si2176_ATV_IEN_PROP_CODE:
       data = (api->prop->atv_ien.chlien  & Si2176_ATV_IEN_PROP_CHLIEN_MASK ) << Si2176_ATV_IEN_PROP_CHLIEN_LSB  |
              (api->prop->atv_ien.pclien  & Si2176_ATV_IEN_PROP_PCLIEN_MASK ) << Si2176_ATV_IEN_PROP_PCLIEN_LSB  |
              (api->prop->atv_ien.dlien   & Si2176_ATV_IEN_PROP_DLIEN_MASK  ) << Si2176_ATV_IEN_PROP_DLIEN_LSB  |
              (api->prop->atv_ien.snrlien & Si2176_ATV_IEN_PROP_SNRLIEN_MASK) << Si2176_ATV_IEN_PROP_SNRLIEN_LSB  |
              (api->prop->atv_ien.snrhien & Si2176_ATV_IEN_PROP_SNRHIEN_MASK) << Si2176_ATV_IEN_PROP_SNRHIEN_LSB ;
     break;
    #endif /*     Si2176_ATV_IEN_PROP */
    #ifdef        Si2176_ATV_INT_SENSE_PROP
     case         Si2176_ATV_INT_SENSE_PROP_CODE:
       data = (api->prop->atv_int_sense.chlnegen  & Si2176_ATV_INT_SENSE_PROP_CHLNEGEN_MASK ) << Si2176_ATV_INT_SENSE_PROP_CHLNEGEN_LSB  |
              (api->prop->atv_int_sense.pclnegen  & Si2176_ATV_INT_SENSE_PROP_PCLNEGEN_MASK ) << Si2176_ATV_INT_SENSE_PROP_PCLNEGEN_LSB  |
              (api->prop->atv_int_sense.dlnegen   & Si2176_ATV_INT_SENSE_PROP_DLNEGEN_MASK  ) << Si2176_ATV_INT_SENSE_PROP_DLNEGEN_LSB  |
              (api->prop->atv_int_sense.snrlnegen & Si2176_ATV_INT_SENSE_PROP_SNRLNEGEN_MASK) << Si2176_ATV_INT_SENSE_PROP_SNRLNEGEN_LSB  |
              (api->prop->atv_int_sense.snrhnegen & Si2176_ATV_INT_SENSE_PROP_SNRHNEGEN_MASK) << Si2176_ATV_INT_SENSE_PROP_SNRHNEGEN_LSB  |
              (api->prop->atv_int_sense.chlposen  & Si2176_ATV_INT_SENSE_PROP_CHLPOSEN_MASK ) << Si2176_ATV_INT_SENSE_PROP_CHLPOSEN_LSB  |
              (api->prop->atv_int_sense.pclposen  & Si2176_ATV_INT_SENSE_PROP_PCLPOSEN_MASK ) << Si2176_ATV_INT_SENSE_PROP_PCLPOSEN_LSB  |
              (api->prop->atv_int_sense.dlposen   & Si2176_ATV_INT_SENSE_PROP_DLPOSEN_MASK  ) << Si2176_ATV_INT_SENSE_PROP_DLPOSEN_LSB  |
              (api->prop->atv_int_sense.snrlposen & Si2176_ATV_INT_SENSE_PROP_SNRLPOSEN_MASK) << Si2176_ATV_INT_SENSE_PROP_SNRLPOSEN_LSB  |
              (api->prop->atv_int_sense.snrhposen & Si2176_ATV_INT_SENSE_PROP_SNRHPOSEN_MASK) << Si2176_ATV_INT_SENSE_PROP_SNRHPOSEN_LSB ;
     break;
    #endif /*     Si2176_ATV_INT_SENSE_PROP */
    #ifdef        Si2176_ATV_RF_TOP_PROP
     case         Si2176_ATV_RF_TOP_PROP_CODE:
       data = (api->prop->atv_rf_top.atv_rf_top & Si2176_ATV_RF_TOP_PROP_ATV_RF_TOP_MASK) << Si2176_ATV_RF_TOP_PROP_ATV_RF_TOP_LSB ;
     break;
    #endif /*     Si2176_ATV_RF_TOP_PROP */
    #ifdef        Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP_CODE:
       data = (api->prop->atv_rsq_rssi_threshold.lo & Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK) << Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB  |
              (api->prop->atv_rsq_rssi_threshold.hi & Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK) << Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB ;
     break;
    #endif /*     Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2176_ATV_RSQ_SNR_THRESHOLD_PROP
     case         Si2176_ATV_RSQ_SNR_THRESHOLD_PROP_CODE:
       data = (api->prop->atv_rsq_snr_threshold.lo & Si2176_ATV_RSQ_SNR_THRESHOLD_PROP_LO_MASK) << Si2176_ATV_RSQ_SNR_THRESHOLD_PROP_LO_LSB  |
              (api->prop->atv_rsq_snr_threshold.hi & Si2176_ATV_RSQ_SNR_THRESHOLD_PROP_HI_MASK) << Si2176_ATV_RSQ_SNR_THRESHOLD_PROP_HI_LSB ;
     break;
    #endif /*     Si2176_ATV_RSQ_SNR_THRESHOLD_PROP */
    #ifdef        Si2176_ATV_SIF_OUT_PROP
     case         Si2176_ATV_SIF_OUT_PROP_CODE:
       data = (api->prop->atv_sif_out.offset & Si2176_ATV_SIF_OUT_PROP_OFFSET_MASK) << Si2176_ATV_SIF_OUT_PROP_OFFSET_LSB  |
              (api->prop->atv_sif_out.amp    & Si2176_ATV_SIF_OUT_PROP_AMP_MASK   ) << Si2176_ATV_SIF_OUT_PROP_AMP_LSB ;
     break;
    #endif /*     Si2176_ATV_SIF_OUT_PROP */
    #ifdef        Si2176_ATV_SOUND_AGC_LIMIT_PROP
     case         Si2176_ATV_SOUND_AGC_LIMIT_PROP_CODE:
       data = (api->prop->atv_sound_agc_limit.max_gain & Si2176_ATV_SOUND_AGC_LIMIT_PROP_MAX_GAIN_MASK) << Si2176_ATV_SOUND_AGC_LIMIT_PROP_MAX_GAIN_LSB  |
              (api->prop->atv_sound_agc_limit.min_gain & Si2176_ATV_SOUND_AGC_LIMIT_PROP_MIN_GAIN_MASK) << Si2176_ATV_SOUND_AGC_LIMIT_PROP_MIN_GAIN_LSB ;
     break;
    #endif /*     Si2176_ATV_SOUND_AGC_LIMIT_PROP */
    #ifdef        Si2176_ATV_SOUND_AGC_SPEED_PROP
     case         Si2176_ATV_SOUND_AGC_SPEED_PROP_CODE:
       data = (api->prop->atv_sound_agc_speed.system_l      & Si2176_ATV_SOUND_AGC_SPEED_PROP_SYSTEM_L_MASK     ) << Si2176_ATV_SOUND_AGC_SPEED_PROP_SYSTEM_L_LSB  |
              (api->prop->atv_sound_agc_speed.other_systems & Si2176_ATV_SOUND_AGC_SPEED_PROP_OTHER_SYSTEMS_MASK) << Si2176_ATV_SOUND_AGC_SPEED_PROP_OTHER_SYSTEMS_LSB ;
     break;
    #endif /*     Si2176_ATV_SOUND_AGC_SPEED_PROP */
    #ifdef        Si2176_ATV_VIDEO_EQUALIZER_PROP
     case         Si2176_ATV_VIDEO_EQUALIZER_PROP_CODE:
       data = (api->prop->atv_video_equalizer.slope & Si2176_ATV_VIDEO_EQUALIZER_PROP_SLOPE_MASK) << Si2176_ATV_VIDEO_EQUALIZER_PROP_SLOPE_LSB ;
     break;
    #endif /*     Si2176_ATV_VIDEO_EQUALIZER_PROP */
    #ifdef        Si2176_ATV_VIDEO_MODE_PROP
     case         Si2176_ATV_VIDEO_MODE_PROP_CODE:
       data = (api->prop->atv_video_mode.video_sys     & Si2176_ATV_VIDEO_MODE_PROP_VIDEO_SYS_MASK    ) << Si2176_ATV_VIDEO_MODE_PROP_VIDEO_SYS_LSB  |
              (api->prop->atv_video_mode.color         & Si2176_ATV_VIDEO_MODE_PROP_COLOR_MASK        ) << Si2176_ATV_VIDEO_MODE_PROP_COLOR_LSB  |
              (api->prop->atv_video_mode.trans         & Si2176_ATV_VIDEO_MODE_PROP_TRANS_MASK        ) << Si2176_ATV_VIDEO_MODE_PROP_TRANS_LSB  |
              (api->prop->atv_video_mode.invert_signal & Si2176_ATV_VIDEO_MODE_PROP_INVERT_SIGNAL_MASK) << Si2176_ATV_VIDEO_MODE_PROP_INVERT_SIGNAL_LSB ;
     break;
    #endif /*     Si2176_ATV_VIDEO_MODE_PROP */
    #ifdef        Si2176_ATV_VSNR_CAP_PROP
     case         Si2176_ATV_VSNR_CAP_PROP_CODE:
       data = (api->prop->atv_vsnr_cap.atv_vsnr_cap & Si2176_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_MASK) << Si2176_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_LSB ;
     break;
    #endif /*     Si2176_ATV_VSNR_CAP_PROP */
    #ifdef        Si2176_CRYSTAL_TRIM_PROP
     case         Si2176_CRYSTAL_TRIM_PROP_CODE:
       data = (api->prop->crystal_trim.xo_cap & Si2176_CRYSTAL_TRIM_PROP_XO_CAP_MASK) << Si2176_CRYSTAL_TRIM_PROP_XO_CAP_LSB ;
     break;
    #endif /*     Si2176_CRYSTAL_TRIM_PROP */
    #ifdef        Si2176_DTV_AGC_FREEZE_INPUT_PROP
     case         Si2176_DTV_AGC_FREEZE_INPUT_PROP_CODE:
       data = (api->prop->dtv_agc_freeze_input.level & Si2176_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_MASK) << Si2176_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_LSB  |
              (api->prop->dtv_agc_freeze_input.pin   & Si2176_DTV_AGC_FREEZE_INPUT_PROP_PIN_MASK  ) << Si2176_DTV_AGC_FREEZE_INPUT_PROP_PIN_LSB ;
     break;
    #endif /*     Si2176_DTV_AGC_FREEZE_INPUT_PROP */
    #ifdef        Si2176_DTV_AGC_SPEED_PROP
     case         Si2176_DTV_AGC_SPEED_PROP_CODE:
       data = (api->prop->dtv_agc_speed.if_agc_speed & Si2176_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK) << Si2176_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB  |
              (api->prop->dtv_agc_speed.agc_decim    & Si2176_DTV_AGC_SPEED_PROP_AGC_DECIM_MASK   ) << Si2176_DTV_AGC_SPEED_PROP_AGC_DECIM_LSB ;
     break;
    #endif /*     Si2176_DTV_AGC_SPEED_PROP */
    #ifdef        Si2176_DTV_CONFIG_IF_PORT_PROP
     case         Si2176_DTV_CONFIG_IF_PORT_PROP_CODE:
       data = (api->prop->dtv_config_if_port.dtv_out_type   & Si2176_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_MASK  ) << Si2176_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_LSB  |
              (api->prop->dtv_config_if_port.dtv_agc_source & Si2176_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_MASK) << Si2176_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_LSB ;
     break;
    #endif /*     Si2176_DTV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2176_DTV_EXT_AGC_PROP
     case         Si2176_DTV_EXT_AGC_PROP_CODE:
       data = (api->prop->dtv_ext_agc.min_10mv & Si2176_DTV_EXT_AGC_PROP_MIN_10MV_MASK) << Si2176_DTV_EXT_AGC_PROP_MIN_10MV_LSB  |
              (api->prop->dtv_ext_agc.max_10mv & Si2176_DTV_EXT_AGC_PROP_MAX_10MV_MASK) << Si2176_DTV_EXT_AGC_PROP_MAX_10MV_LSB ;
     break;
    #endif /*     Si2176_DTV_EXT_AGC_PROP */
    #ifdef        Si2176_DTV_FILTER_SELECT_PROP
     case         Si2176_DTV_FILTER_SELECT_PROP_CODE:
       data = (api->prop->dtv_filter_select.filter & Si2176_DTV_FILTER_SELECT_PROP_FILTER_MASK) << Si2176_DTV_FILTER_SELECT_PROP_FILTER_LSB ;
     break;
    #endif /*     Si2176_DTV_FILTER_SELECT_PROP */
    #ifdef        Si2176_DTV_IEN_PROP
     case         Si2176_DTV_IEN_PROP_CODE:
       data = (api->prop->dtv_ien.chlien & Si2176_DTV_IEN_PROP_CHLIEN_MASK) << Si2176_DTV_IEN_PROP_CHLIEN_LSB ;
     break;
    #endif /*     Si2176_DTV_IEN_PROP */
    #ifdef        Si2176_DTV_INITIAL_AGC_SPEED_PROP
     case         Si2176_DTV_INITIAL_AGC_SPEED_PROP_CODE:
       data = (api->prop->dtv_initial_agc_speed.if_agc_speed & Si2176_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_MASK) << Si2176_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_LSB  |
              (api->prop->dtv_initial_agc_speed.agc_decim    & Si2176_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_MASK   ) << Si2176_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_LSB ;
     break;
    #endif /*     Si2176_DTV_INITIAL_AGC_SPEED_PROP */
    #ifdef        Si2176_DTV_INITIAL_AGC_SPEED_PERIOD_PROP
     case         Si2176_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_CODE:
       data = (api->prop->dtv_initial_agc_speed_period.period & Si2176_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_MASK) << Si2176_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_LSB ;
     break;
    #endif /*     Si2176_DTV_INITIAL_AGC_SPEED_PERIOD_PROP */
    #ifdef        Si2176_DTV_INTERNAL_ZIF_PROP
     case         Si2176_DTV_INTERNAL_ZIF_PROP_CODE:
       data = (api->prop->dtv_internal_zif.atsc   & Si2176_DTV_INTERNAL_ZIF_PROP_ATSC_MASK  ) << Si2176_DTV_INTERNAL_ZIF_PROP_ATSC_LSB  |
              (api->prop->dtv_internal_zif.qam_us & Si2176_DTV_INTERNAL_ZIF_PROP_QAM_US_MASK) << Si2176_DTV_INTERNAL_ZIF_PROP_QAM_US_LSB  |
              (api->prop->dtv_internal_zif.dvbt   & Si2176_DTV_INTERNAL_ZIF_PROP_DVBT_MASK  ) << Si2176_DTV_INTERNAL_ZIF_PROP_DVBT_LSB  |
              (api->prop->dtv_internal_zif.dvbc   & Si2176_DTV_INTERNAL_ZIF_PROP_DVBC_MASK  ) << Si2176_DTV_INTERNAL_ZIF_PROP_DVBC_LSB  |
              (api->prop->dtv_internal_zif.isdbt  & Si2176_DTV_INTERNAL_ZIF_PROP_ISDBT_MASK ) << Si2176_DTV_INTERNAL_ZIF_PROP_ISDBT_LSB  |
              (api->prop->dtv_internal_zif.isdbc  & Si2176_DTV_INTERNAL_ZIF_PROP_ISDBC_MASK ) << Si2176_DTV_INTERNAL_ZIF_PROP_ISDBC_LSB  |
              (api->prop->dtv_internal_zif.dtmb   & Si2176_DTV_INTERNAL_ZIF_PROP_DTMB_MASK  ) << Si2176_DTV_INTERNAL_ZIF_PROP_DTMB_LSB ;
     break;
    #endif /*     Si2176_DTV_INTERNAL_ZIF_PROP */
    #ifdef        Si2176_DTV_INT_SENSE_PROP
     case         Si2176_DTV_INT_SENSE_PROP_CODE:
       data = (api->prop->dtv_int_sense.chlnegen & Si2176_DTV_INT_SENSE_PROP_CHLNEGEN_MASK) << Si2176_DTV_INT_SENSE_PROP_CHLNEGEN_LSB  |
              (api->prop->dtv_int_sense.chlposen & Si2176_DTV_INT_SENSE_PROP_CHLPOSEN_MASK) << Si2176_DTV_INT_SENSE_PROP_CHLPOSEN_LSB ;
     break;
    #endif /*     Si2176_DTV_INT_SENSE_PROP */
    #ifdef        Si2176_DTV_LIF_FREQ_PROP
     case         Si2176_DTV_LIF_FREQ_PROP_CODE:
       data = (api->prop->dtv_lif_freq.offset & Si2176_DTV_LIF_FREQ_PROP_OFFSET_MASK) << Si2176_DTV_LIF_FREQ_PROP_OFFSET_LSB ;
     break;
    #endif /*     Si2176_DTV_LIF_FREQ_PROP */
    #ifdef        Si2176_DTV_LIF_OUT_PROP
     case         Si2176_DTV_LIF_OUT_PROP_CODE:
       data = (api->prop->dtv_lif_out.offset & Si2176_DTV_LIF_OUT_PROP_OFFSET_MASK) << Si2176_DTV_LIF_OUT_PROP_OFFSET_LSB  |
              (api->prop->dtv_lif_out.amp    & Si2176_DTV_LIF_OUT_PROP_AMP_MASK   ) << Si2176_DTV_LIF_OUT_PROP_AMP_LSB ;
     break;
    #endif /*     Si2176_DTV_LIF_OUT_PROP */
    #ifdef        Si2176_DTV_MODE_PROP
     case         Si2176_DTV_MODE_PROP_CODE:
       data = (api->prop->dtv_mode.bw              & Si2176_DTV_MODE_PROP_BW_MASK             ) << Si2176_DTV_MODE_PROP_BW_LSB  |
              (api->prop->dtv_mode.modulation      & Si2176_DTV_MODE_PROP_MODULATION_MASK     ) << Si2176_DTV_MODE_PROP_MODULATION_LSB  |
              (api->prop->dtv_mode.invert_spectrum & Si2176_DTV_MODE_PROP_INVERT_SPECTRUM_MASK) << Si2176_DTV_MODE_PROP_INVERT_SPECTRUM_LSB ;
     break;
    #endif /*     Si2176_DTV_MODE_PROP */
    #ifdef        Si2176_DTV_RF_TOP_PROP
     case         Si2176_DTV_RF_TOP_PROP_CODE:
       data = (api->prop->dtv_rf_top.dtv_rf_top & Si2176_DTV_RF_TOP_PROP_DTV_RF_TOP_MASK) << Si2176_DTV_RF_TOP_PROP_DTV_RF_TOP_LSB ;
     break;
    #endif /*     Si2176_DTV_RF_TOP_PROP */
    #ifdef        Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP_CODE:
       data = (api->prop->dtv_rsq_rssi_threshold.lo & Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK) << Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB  |
              (api->prop->dtv_rsq_rssi_threshold.hi & Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK) << Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB ;
     break;
    #endif /*     Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2176_MASTER_IEN_PROP
     case         Si2176_MASTER_IEN_PROP_CODE:
       data = (api->prop->master_ien.tunien & Si2176_MASTER_IEN_PROP_TUNIEN_MASK) << Si2176_MASTER_IEN_PROP_TUNIEN_LSB  |
              (api->prop->master_ien.atvien & Si2176_MASTER_IEN_PROP_ATVIEN_MASK) << Si2176_MASTER_IEN_PROP_ATVIEN_LSB  |
              (api->prop->master_ien.dtvien & Si2176_MASTER_IEN_PROP_DTVIEN_MASK) << Si2176_MASTER_IEN_PROP_DTVIEN_LSB  |
              (api->prop->master_ien.errien & Si2176_MASTER_IEN_PROP_ERRIEN_MASK) << Si2176_MASTER_IEN_PROP_ERRIEN_LSB  |
              (api->prop->master_ien.ctsien & Si2176_MASTER_IEN_PROP_CTSIEN_MASK) << Si2176_MASTER_IEN_PROP_CTSIEN_LSB ;
     break;
    #endif /*     Si2176_MASTER_IEN_PROP */
    #ifdef        Si2176_TUNER_BLOCKED_VCO_PROP
     case         Si2176_TUNER_BLOCKED_VCO_PROP_CODE:
       data = (api->prop->tuner_blocked_vco.vco_code & Si2176_TUNER_BLOCKED_VCO_PROP_VCO_CODE_MASK) << Si2176_TUNER_BLOCKED_VCO_PROP_VCO_CODE_LSB ;
     break;
    #endif /*     Si2176_TUNER_BLOCKED_VCO_PROP */
    #ifdef        Si2176_TUNER_IEN_PROP
     case         Si2176_TUNER_IEN_PROP_CODE:
       data = (api->prop->tuner_ien.tcien    & Si2176_TUNER_IEN_PROP_TCIEN_MASK   ) << Si2176_TUNER_IEN_PROP_TCIEN_LSB  |
              (api->prop->tuner_ien.rssilien & Si2176_TUNER_IEN_PROP_RSSILIEN_MASK) << Si2176_TUNER_IEN_PROP_RSSILIEN_LSB  |
              (api->prop->tuner_ien.rssihien & Si2176_TUNER_IEN_PROP_RSSIHIEN_MASK) << Si2176_TUNER_IEN_PROP_RSSIHIEN_LSB ;
     break;
    #endif /*     Si2176_TUNER_IEN_PROP */
    #ifdef        Si2176_TUNER_INT_SENSE_PROP
     case         Si2176_TUNER_INT_SENSE_PROP_CODE:
       data = (api->prop->tuner_int_sense.tcnegen    & Si2176_TUNER_INT_SENSE_PROP_TCNEGEN_MASK   ) << Si2176_TUNER_INT_SENSE_PROP_TCNEGEN_LSB  |
              (api->prop->tuner_int_sense.rssilnegen & Si2176_TUNER_INT_SENSE_PROP_RSSILNEGEN_MASK) << Si2176_TUNER_INT_SENSE_PROP_RSSILNEGEN_LSB  |
              (api->prop->tuner_int_sense.rssihnegen & Si2176_TUNER_INT_SENSE_PROP_RSSIHNEGEN_MASK) << Si2176_TUNER_INT_SENSE_PROP_RSSIHNEGEN_LSB  |
              (api->prop->tuner_int_sense.tcposen    & Si2176_TUNER_INT_SENSE_PROP_TCPOSEN_MASK   ) << Si2176_TUNER_INT_SENSE_PROP_TCPOSEN_LSB  |
              (api->prop->tuner_int_sense.rssilposen & Si2176_TUNER_INT_SENSE_PROP_RSSILPOSEN_MASK) << Si2176_TUNER_INT_SENSE_PROP_RSSILPOSEN_LSB  |
              (api->prop->tuner_int_sense.rssihposen & Si2176_TUNER_INT_SENSE_PROP_RSSIHPOSEN_MASK) << Si2176_TUNER_INT_SENSE_PROP_RSSIHPOSEN_LSB ;
     break;
    #endif /*     Si2176_TUNER_INT_SENSE_PROP */
    #ifdef        Si2176_TUNER_LO_INJECTION_PROP
     case         Si2176_TUNER_LO_INJECTION_PROP_CODE:
       data = (api->prop->tuner_lo_injection.band_1 & Si2176_TUNER_LO_INJECTION_PROP_BAND_1_MASK) << Si2176_TUNER_LO_INJECTION_PROP_BAND_1_LSB  |
              (api->prop->tuner_lo_injection.band_2 & Si2176_TUNER_LO_INJECTION_PROP_BAND_2_MASK) << Si2176_TUNER_LO_INJECTION_PROP_BAND_2_LSB  |
              (api->prop->tuner_lo_injection.band_3 & Si2176_TUNER_LO_INJECTION_PROP_BAND_3_MASK) << Si2176_TUNER_LO_INJECTION_PROP_BAND_3_LSB  |
              (api->prop->tuner_lo_injection.band_4 & Si2176_TUNER_LO_INJECTION_PROP_BAND_4_MASK) << Si2176_TUNER_LO_INJECTION_PROP_BAND_4_LSB  |
              (api->prop->tuner_lo_injection.band_5 & Si2176_TUNER_LO_INJECTION_PROP_BAND_5_MASK) << Si2176_TUNER_LO_INJECTION_PROP_BAND_5_LSB ;
     break;
    #endif /*     Si2176_TUNER_LO_INJECTION_PROP */
   default : break;
    }
#ifdef    Si2176_GET_PROPERTY_STRING
    Si2176_L1_FillPropertyStringText(api, prop_code, (char*)" ", msg);
    SiTRACE("%s\n",msg);
#endif /* Si2176_GET_PROPERTY_STRING */
    return Si2176_L1_SetProperty(api, prop_code & 0xffff , data);
  }
...
/* _get_property2_insertion_start */
  ...
  /* --------------------------------------------*/
unsigned char Si2176_L1_GetProperty2(L1_Si2176_Context *api, unsigned int prop_code) {
    int data, res;
    res = Si2176_L1_GetProperty(api,prop_code & 0xffff,&data);
    if (res!=NO_Si2176_ERROR) return res;
    switch (prop_code) {
    #ifdef        Si2176_ATV_AFC_RANGE_PROP
     case         Si2176_ATV_AFC_RANGE_PROP_CODE:
               api->prop->atv_afc_range.range_khz = (data >> Si2176_ATV_AFC_RANGE_PROP_RANGE_KHZ_LSB) & Si2176_ATV_AFC_RANGE_PROP_RANGE_KHZ_MASK;
     break;
    #endif /*     Si2176_ATV_AFC_RANGE_PROP */
    #ifdef        Si2176_ATV_AF_OUT_PROP
     case         Si2176_ATV_AF_OUT_PROP_CODE:
               api->prop->atv_af_out.volume = (data >> Si2176_ATV_AF_OUT_PROP_VOLUME_LSB) & Si2176_ATV_AF_OUT_PROP_VOLUME_MASK;
     break;
    #endif /*     Si2176_ATV_AF_OUT_PROP */
    #ifdef        Si2176_ATV_AGC_SPEED_PROP
     case         Si2176_ATV_AGC_SPEED_PROP_CODE:
               api->prop->atv_agc_speed.if_agc_speed = (data >> Si2176_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB) & Si2176_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
     break;
    #endif /*     Si2176_ATV_AGC_SPEED_PROP */
    #ifdef        Si2176_ATV_AUDIO_MODE_PROP
     case         Si2176_ATV_AUDIO_MODE_PROP_CODE:
               api->prop->atv_audio_mode.audio_sys  = (data >> Si2176_ATV_AUDIO_MODE_PROP_AUDIO_SYS_LSB ) & Si2176_ATV_AUDIO_MODE_PROP_AUDIO_SYS_MASK;
               api->prop->atv_audio_mode.demod_mode = (data >> Si2176_ATV_AUDIO_MODE_PROP_DEMOD_MODE_LSB) & Si2176_ATV_AUDIO_MODE_PROP_DEMOD_MODE_MASK;
               api->prop->atv_audio_mode.chan_bw    = (data >> Si2176_ATV_AUDIO_MODE_PROP_CHAN_BW_LSB   ) & Si2176_ATV_AUDIO_MODE_PROP_CHAN_BW_MASK;
     break;
    #endif /*     Si2176_ATV_AUDIO_MODE_PROP */
    #ifdef        Si2176_ATV_CVBS_OUT_PROP
     case         Si2176_ATV_CVBS_OUT_PROP_CODE:
               api->prop->atv_cvbs_out.offset = (data >> Si2176_ATV_CVBS_OUT_PROP_OFFSET_LSB) & Si2176_ATV_CVBS_OUT_PROP_OFFSET_MASK;
               api->prop->atv_cvbs_out.amp    = (data >> Si2176_ATV_CVBS_OUT_PROP_AMP_LSB   ) & Si2176_ATV_CVBS_OUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2176_ATV_CVBS_OUT_PROP */
    #ifdef        Si2176_ATV_CVBS_OUT_FINE_PROP
     case         Si2176_ATV_CVBS_OUT_FINE_PROP_CODE:
               api->prop->atv_cvbs_out_fine.offset = (data >> Si2176_ATV_CVBS_OUT_FINE_PROP_OFFSET_LSB) & Si2176_ATV_CVBS_OUT_FINE_PROP_OFFSET_MASK;
               api->prop->atv_cvbs_out_fine.amp    = (data >> Si2176_ATV_CVBS_OUT_FINE_PROP_AMP_LSB   ) & Si2176_ATV_CVBS_OUT_FINE_PROP_AMP_MASK;
     break;
    #endif /*     Si2176_ATV_CVBS_OUT_FINE_PROP */
    #ifdef        Si2176_ATV_IEN_PROP
     case         Si2176_ATV_IEN_PROP_CODE:
               api->prop->atv_ien.chlien  = (data >> Si2176_ATV_IEN_PROP_CHLIEN_LSB ) & Si2176_ATV_IEN_PROP_CHLIEN_MASK;
               api->prop->atv_ien.pclien  = (data >> Si2176_ATV_IEN_PROP_PCLIEN_LSB ) & Si2176_ATV_IEN_PROP_PCLIEN_MASK;
               api->prop->atv_ien.dlien   = (data >> Si2176_ATV_IEN_PROP_DLIEN_LSB  ) & Si2176_ATV_IEN_PROP_DLIEN_MASK;
               api->prop->atv_ien.snrlien = (data >> Si2176_ATV_IEN_PROP_SNRLIEN_LSB) & Si2176_ATV_IEN_PROP_SNRLIEN_MASK;
               api->prop->atv_ien.snrhien = (data >> Si2176_ATV_IEN_PROP_SNRHIEN_LSB) & Si2176_ATV_IEN_PROP_SNRHIEN_MASK;
     break;
    #endif /*     Si2176_ATV_IEN_PROP */
    #ifdef        Si2176_ATV_INT_SENSE_PROP
     case         Si2176_ATV_INT_SENSE_PROP_CODE:
               api->prop->atv_int_sense.chlnegen  = (data >> Si2176_ATV_INT_SENSE_PROP_CHLNEGEN_LSB ) & Si2176_ATV_INT_SENSE_PROP_CHLNEGEN_MASK;
               api->prop->atv_int_sense.pclnegen  = (data >> Si2176_ATV_INT_SENSE_PROP_PCLNEGEN_LSB ) & Si2176_ATV_INT_SENSE_PROP_PCLNEGEN_MASK;
               api->prop->atv_int_sense.dlnegen   = (data >> Si2176_ATV_INT_SENSE_PROP_DLNEGEN_LSB  ) & Si2176_ATV_INT_SENSE_PROP_DLNEGEN_MASK;
               api->prop->atv_int_sense.snrlnegen = (data >> Si2176_ATV_INT_SENSE_PROP_SNRLNEGEN_LSB) & Si2176_ATV_INT_SENSE_PROP_SNRLNEGEN_MASK;
               api->prop->atv_int_sense.snrhnegen = (data >> Si2176_ATV_INT_SENSE_PROP_SNRHNEGEN_LSB) & Si2176_ATV_INT_SENSE_PROP_SNRHNEGEN_MASK;
               api->prop->atv_int_sense.chlposen  = (data >> Si2176_ATV_INT_SENSE_PROP_CHLPOSEN_LSB ) & Si2176_ATV_INT_SENSE_PROP_CHLPOSEN_MASK;
               api->prop->atv_int_sense.pclposen  = (data >> Si2176_ATV_INT_SENSE_PROP_PCLPOSEN_LSB ) & Si2176_ATV_INT_SENSE_PROP_PCLPOSEN_MASK;
               api->prop->atv_int_sense.dlposen   = (data >> Si2176_ATV_INT_SENSE_PROP_DLPOSEN_LSB  ) & Si2176_ATV_INT_SENSE_PROP_DLPOSEN_MASK;
               api->prop->atv_int_sense.snrlposen = (data >> Si2176_ATV_INT_SENSE_PROP_SNRLPOSEN_LSB) & Si2176_ATV_INT_SENSE_PROP_SNRLPOSEN_MASK;
               api->prop->atv_int_sense.snrhposen = (data >> Si2176_ATV_INT_SENSE_PROP_SNRHPOSEN_LSB) & Si2176_ATV_INT_SENSE_PROP_SNRHPOSEN_MASK;
     break;
    #endif /*     Si2176_ATV_INT_SENSE_PROP */
    #ifdef        Si2176_ATV_RF_TOP_PROP
     case         Si2176_ATV_RF_TOP_PROP_CODE:
               api->prop->atv_rf_top.atv_rf_top = (data >> Si2176_ATV_RF_TOP_PROP_ATV_RF_TOP_LSB) & Si2176_ATV_RF_TOP_PROP_ATV_RF_TOP_MASK;
     break;
    #endif /*     Si2176_ATV_RF_TOP_PROP */
    #ifdef        Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP_CODE:
               api->prop->atv_rsq_rssi_threshold.lo = (data >> Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB) & Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK;
               api->prop->atv_rsq_rssi_threshold.hi = (data >> Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB) & Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK;
     break;
    #endif /*     Si2176_ATV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2176_ATV_RSQ_SNR_THRESHOLD_PROP
     case         Si2176_ATV_RSQ_SNR_THRESHOLD_PROP_CODE:
               api->prop->atv_rsq_snr_threshold.lo = (data >> Si2176_ATV_RSQ_SNR_THRESHOLD_PROP_LO_LSB) & Si2176_ATV_RSQ_SNR_THRESHOLD_PROP_LO_MASK;
               api->prop->atv_rsq_snr_threshold.hi = (data >> Si2176_ATV_RSQ_SNR_THRESHOLD_PROP_HI_LSB) & Si2176_ATV_RSQ_SNR_THRESHOLD_PROP_HI_MASK;
     break;
    #endif /*     Si2176_ATV_RSQ_SNR_THRESHOLD_PROP */
    #ifdef        Si2176_ATV_SIF_OUT_PROP
     case         Si2176_ATV_SIF_OUT_PROP_CODE:
               api->prop->atv_sif_out.offset = (data >> Si2176_ATV_SIF_OUT_PROP_OFFSET_LSB) & Si2176_ATV_SIF_OUT_PROP_OFFSET_MASK;
               api->prop->atv_sif_out.amp    = (data >> Si2176_ATV_SIF_OUT_PROP_AMP_LSB   ) & Si2176_ATV_SIF_OUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2176_ATV_SIF_OUT_PROP */
    #ifdef        Si2176_ATV_SOUND_AGC_LIMIT_PROP
     case         Si2176_ATV_SOUND_AGC_LIMIT_PROP_CODE:
               api->prop->atv_sound_agc_limit.max_gain = (data >> Si2176_ATV_SOUND_AGC_LIMIT_PROP_MAX_GAIN_LSB) & Si2176_ATV_SOUND_AGC_LIMIT_PROP_MAX_GAIN_MASK;
               api->prop->atv_sound_agc_limit.min_gain = (data >> Si2176_ATV_SOUND_AGC_LIMIT_PROP_MIN_GAIN_LSB) & Si2176_ATV_SOUND_AGC_LIMIT_PROP_MIN_GAIN_MASK;
     break;
    #endif /*     Si2176_ATV_SOUND_AGC_LIMIT_PROP */
    #ifdef        Si2176_ATV_SOUND_AGC_SPEED_PROP
     case         Si2176_ATV_SOUND_AGC_SPEED_PROP_CODE:
               api->prop->atv_sound_agc_speed.system_l      = (data >> Si2176_ATV_SOUND_AGC_SPEED_PROP_SYSTEM_L_LSB     ) & Si2176_ATV_SOUND_AGC_SPEED_PROP_SYSTEM_L_MASK;
               api->prop->atv_sound_agc_speed.other_systems = (data >> Si2176_ATV_SOUND_AGC_SPEED_PROP_OTHER_SYSTEMS_LSB) & Si2176_ATV_SOUND_AGC_SPEED_PROP_OTHER_SYSTEMS_MASK;
     break;
    #endif /*     Si2176_ATV_SOUND_AGC_SPEED_PROP */
    #ifdef        Si2176_ATV_VIDEO_EQUALIZER_PROP
     case         Si2176_ATV_VIDEO_EQUALIZER_PROP_CODE:
               api->prop->atv_video_equalizer.slope = (data >> Si2176_ATV_VIDEO_EQUALIZER_PROP_SLOPE_LSB) & Si2176_ATV_VIDEO_EQUALIZER_PROP_SLOPE_MASK;
     break;
    #endif /*     Si2176_ATV_VIDEO_EQUALIZER_PROP */
    #ifdef        Si2176_ATV_VIDEO_MODE_PROP
     case         Si2176_ATV_VIDEO_MODE_PROP_CODE:
               api->prop->atv_video_mode.video_sys     = (data >> Si2176_ATV_VIDEO_MODE_PROP_VIDEO_SYS_LSB    ) & Si2176_ATV_VIDEO_MODE_PROP_VIDEO_SYS_MASK;
               api->prop->atv_video_mode.color         = (data >> Si2176_ATV_VIDEO_MODE_PROP_COLOR_LSB        ) & Si2176_ATV_VIDEO_MODE_PROP_COLOR_MASK;
               api->prop->atv_video_mode.trans         = (data >> Si2176_ATV_VIDEO_MODE_PROP_TRANS_LSB        ) & Si2176_ATV_VIDEO_MODE_PROP_TRANS_MASK;
               api->prop->atv_video_mode.invert_signal = (data >> Si2176_ATV_VIDEO_MODE_PROP_INVERT_SIGNAL_LSB) & Si2176_ATV_VIDEO_MODE_PROP_INVERT_SIGNAL_MASK;
     break;
    #endif /*     Si2176_ATV_VIDEO_MODE_PROP */
    #ifdef        Si2176_ATV_VSNR_CAP_PROP
     case         Si2176_ATV_VSNR_CAP_PROP_CODE:
               api->prop->atv_vsnr_cap.atv_vsnr_cap = (data >> Si2176_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_LSB) & Si2176_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_MASK;
     break;
    #endif /*     Si2176_ATV_VSNR_CAP_PROP */
    #ifdef        Si2176_CRYSTAL_TRIM_PROP
     case         Si2176_CRYSTAL_TRIM_PROP_CODE:
               api->prop->crystal_trim.xo_cap = (data >> Si2176_CRYSTAL_TRIM_PROP_XO_CAP_LSB) & Si2176_CRYSTAL_TRIM_PROP_XO_CAP_MASK;
     break;
    #endif /*     Si2176_CRYSTAL_TRIM_PROP */
    #ifdef        Si2176_DTV_AGC_FREEZE_INPUT_PROP
     case         Si2176_DTV_AGC_FREEZE_INPUT_PROP_CODE:
               api->prop->dtv_agc_freeze_input.level = (data >> Si2176_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_LSB) & Si2176_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_MASK;
               api->prop->dtv_agc_freeze_input.pin   = (data >> Si2176_DTV_AGC_FREEZE_INPUT_PROP_PIN_LSB  ) & Si2176_DTV_AGC_FREEZE_INPUT_PROP_PIN_MASK;
     break;
    #endif /*     Si2176_DTV_AGC_FREEZE_INPUT_PROP */
    #ifdef        Si2176_DTV_AGC_SPEED_PROP
     case         Si2176_DTV_AGC_SPEED_PROP_CODE:
               api->prop->dtv_agc_speed.if_agc_speed = (data >> Si2176_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB) & Si2176_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
               api->prop->dtv_agc_speed.agc_decim    = (data >> Si2176_DTV_AGC_SPEED_PROP_AGC_DECIM_LSB   ) & Si2176_DTV_AGC_SPEED_PROP_AGC_DECIM_MASK;
     break;
    #endif /*     Si2176_DTV_AGC_SPEED_PROP */
    #ifdef        Si2176_DTV_CONFIG_IF_PORT_PROP
     case         Si2176_DTV_CONFIG_IF_PORT_PROP_CODE:
               api->prop->dtv_config_if_port.dtv_out_type   = (data >> Si2176_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_LSB  ) & Si2176_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_MASK;
               api->prop->dtv_config_if_port.dtv_agc_source = (data >> Si2176_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_LSB) & Si2176_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_MASK;
     break;
    #endif /*     Si2176_DTV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2176_DTV_EXT_AGC_PROP
     case         Si2176_DTV_EXT_AGC_PROP_CODE:
               api->prop->dtv_ext_agc.min_10mv = (data >> Si2176_DTV_EXT_AGC_PROP_MIN_10MV_LSB) & Si2176_DTV_EXT_AGC_PROP_MIN_10MV_MASK;
               api->prop->dtv_ext_agc.max_10mv = (data >> Si2176_DTV_EXT_AGC_PROP_MAX_10MV_LSB) & Si2176_DTV_EXT_AGC_PROP_MAX_10MV_MASK;
     break;
    #endif /*     Si2176_DTV_EXT_AGC_PROP */
    #ifdef        Si2176_DTV_FILTER_SELECT_PROP
     case         Si2176_DTV_FILTER_SELECT_PROP_CODE:
               api->prop->dtv_filter_select.filter = (data >> Si2176_DTV_FILTER_SELECT_PROP_FILTER_LSB) & Si2176_DTV_FILTER_SELECT_PROP_FILTER_MASK;
     break;
    #endif /*     Si2176_DTV_FILTER_SELECT_PROP */
    #ifdef        Si2176_DTV_IEN_PROP
     case         Si2176_DTV_IEN_PROP_CODE:
               api->prop->dtv_ien.chlien = (data >> Si2176_DTV_IEN_PROP_CHLIEN_LSB) & Si2176_DTV_IEN_PROP_CHLIEN_MASK;
     break;
    #endif /*     Si2176_DTV_IEN_PROP */
    #ifdef        Si2176_DTV_INITIAL_AGC_SPEED_PROP
     case         Si2176_DTV_INITIAL_AGC_SPEED_PROP_CODE:
               api->prop->dtv_initial_agc_speed.if_agc_speed = (data >> Si2176_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_LSB) & Si2176_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
               api->prop->dtv_initial_agc_speed.agc_decim    = (data >> Si2176_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_LSB   ) & Si2176_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_MASK;
     break;
    #endif /*     Si2176_DTV_INITIAL_AGC_SPEED_PROP */
    #ifdef        Si2176_DTV_INITIAL_AGC_SPEED_PERIOD_PROP
     case         Si2176_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_CODE:
               api->prop->dtv_initial_agc_speed_period.period = (data >> Si2176_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_LSB) & Si2176_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_MASK;
     break;
    #endif /*     Si2176_DTV_INITIAL_AGC_SPEED_PERIOD_PROP */
    #ifdef        Si2176_DTV_INTERNAL_ZIF_PROP
     case         Si2176_DTV_INTERNAL_ZIF_PROP_CODE:
               api->prop->dtv_internal_zif.atsc   = (data >> Si2176_DTV_INTERNAL_ZIF_PROP_ATSC_LSB  ) & Si2176_DTV_INTERNAL_ZIF_PROP_ATSC_MASK;
               api->prop->dtv_internal_zif.qam_us = (data >> Si2176_DTV_INTERNAL_ZIF_PROP_QAM_US_LSB) & Si2176_DTV_INTERNAL_ZIF_PROP_QAM_US_MASK;
               api->prop->dtv_internal_zif.dvbt   = (data >> Si2176_DTV_INTERNAL_ZIF_PROP_DVBT_LSB  ) & Si2176_DTV_INTERNAL_ZIF_PROP_DVBT_MASK;
               api->prop->dtv_internal_zif.dvbc   = (data >> Si2176_DTV_INTERNAL_ZIF_PROP_DVBC_LSB  ) & Si2176_DTV_INTERNAL_ZIF_PROP_DVBC_MASK;
               api->prop->dtv_internal_zif.isdbt  = (data >> Si2176_DTV_INTERNAL_ZIF_PROP_ISDBT_LSB ) & Si2176_DTV_INTERNAL_ZIF_PROP_ISDBT_MASK;
               api->prop->dtv_internal_zif.isdbc  = (data >> Si2176_DTV_INTERNAL_ZIF_PROP_ISDBC_LSB ) & Si2176_DTV_INTERNAL_ZIF_PROP_ISDBC_MASK;
               api->prop->dtv_internal_zif.dtmb   = (data >> Si2176_DTV_INTERNAL_ZIF_PROP_DTMB_LSB  ) & Si2176_DTV_INTERNAL_ZIF_PROP_DTMB_MASK;
     break;
    #endif /*     Si2176_DTV_INTERNAL_ZIF_PROP */
    #ifdef        Si2176_DTV_INT_SENSE_PROP
     case         Si2176_DTV_INT_SENSE_PROP_CODE:
               api->prop->dtv_int_sense.chlnegen = (data >> Si2176_DTV_INT_SENSE_PROP_CHLNEGEN_LSB) & Si2176_DTV_INT_SENSE_PROP_CHLNEGEN_MASK;
               api->prop->dtv_int_sense.chlposen = (data >> Si2176_DTV_INT_SENSE_PROP_CHLPOSEN_LSB) & Si2176_DTV_INT_SENSE_PROP_CHLPOSEN_MASK;
     break;
    #endif /*     Si2176_DTV_INT_SENSE_PROP */
    #ifdef        Si2176_DTV_LIF_FREQ_PROP
     case         Si2176_DTV_LIF_FREQ_PROP_CODE:
               api->prop->dtv_lif_freq.offset = (data >> Si2176_DTV_LIF_FREQ_PROP_OFFSET_LSB) & Si2176_DTV_LIF_FREQ_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2176_DTV_LIF_FREQ_PROP */
    #ifdef        Si2176_DTV_LIF_OUT_PROP
     case         Si2176_DTV_LIF_OUT_PROP_CODE:
               api->prop->dtv_lif_out.offset = (data >> Si2176_DTV_LIF_OUT_PROP_OFFSET_LSB) & Si2176_DTV_LIF_OUT_PROP_OFFSET_MASK;
               api->prop->dtv_lif_out.amp    = (data >> Si2176_DTV_LIF_OUT_PROP_AMP_LSB   ) & Si2176_DTV_LIF_OUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2176_DTV_LIF_OUT_PROP */
    #ifdef        Si2176_DTV_MODE_PROP
     case         Si2176_DTV_MODE_PROP_CODE:
               api->prop->dtv_mode.bw              = (data >> Si2176_DTV_MODE_PROP_BW_LSB             ) & Si2176_DTV_MODE_PROP_BW_MASK;
               api->prop->dtv_mode.modulation      = (data >> Si2176_DTV_MODE_PROP_MODULATION_LSB     ) & Si2176_DTV_MODE_PROP_MODULATION_MASK;
               api->prop->dtv_mode.invert_spectrum = (data >> Si2176_DTV_MODE_PROP_INVERT_SPECTRUM_LSB) & Si2176_DTV_MODE_PROP_INVERT_SPECTRUM_MASK;
     break;
    #endif /*     Si2176_DTV_MODE_PROP */
    #ifdef        Si2176_DTV_RF_TOP_PROP
     case         Si2176_DTV_RF_TOP_PROP_CODE:
               api->prop->dtv_rf_top.dtv_rf_top = (data >> Si2176_DTV_RF_TOP_PROP_DTV_RF_TOP_LSB) & Si2176_DTV_RF_TOP_PROP_DTV_RF_TOP_MASK;
     break;
    #endif /*     Si2176_DTV_RF_TOP_PROP */
    #ifdef        Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP_CODE:
               api->prop->dtv_rsq_rssi_threshold.lo = (data >> Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB) & Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK;
               api->prop->dtv_rsq_rssi_threshold.hi = (data >> Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB) & Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK;
     break;
    #endif /*     Si2176_DTV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2176_MASTER_IEN_PROP
     case         Si2176_MASTER_IEN_PROP_CODE:
               api->prop->master_ien.tunien = (data >> Si2176_MASTER_IEN_PROP_TUNIEN_LSB) & Si2176_MASTER_IEN_PROP_TUNIEN_MASK;
               api->prop->master_ien.atvien = (data >> Si2176_MASTER_IEN_PROP_ATVIEN_LSB) & Si2176_MASTER_IEN_PROP_ATVIEN_MASK;
               api->prop->master_ien.dtvien = (data >> Si2176_MASTER_IEN_PROP_DTVIEN_LSB) & Si2176_MASTER_IEN_PROP_DTVIEN_MASK;
               api->prop->master_ien.errien = (data >> Si2176_MASTER_IEN_PROP_ERRIEN_LSB) & Si2176_MASTER_IEN_PROP_ERRIEN_MASK;
               api->prop->master_ien.ctsien = (data >> Si2176_MASTER_IEN_PROP_CTSIEN_LSB) & Si2176_MASTER_IEN_PROP_CTSIEN_MASK;
     break;
    #endif /*     Si2176_MASTER_IEN_PROP */
    #ifdef        Si2176_TUNER_BLOCKED_VCO_PROP
     case         Si2176_TUNER_BLOCKED_VCO_PROP_CODE:
               api->prop->tuner_blocked_vco.vco_code = (data >> Si2176_TUNER_BLOCKED_VCO_PROP_VCO_CODE_LSB) & Si2176_TUNER_BLOCKED_VCO_PROP_VCO_CODE_MASK;
     break;
    #endif /*     Si2176_TUNER_BLOCKED_VCO_PROP */
    #ifdef        Si2176_TUNER_IEN_PROP
     case         Si2176_TUNER_IEN_PROP_CODE:
               api->prop->tuner_ien.tcien    = (data >> Si2176_TUNER_IEN_PROP_TCIEN_LSB   ) & Si2176_TUNER_IEN_PROP_TCIEN_MASK;
               api->prop->tuner_ien.rssilien = (data >> Si2176_TUNER_IEN_PROP_RSSILIEN_LSB) & Si2176_TUNER_IEN_PROP_RSSILIEN_MASK;
               api->prop->tuner_ien.rssihien = (data >> Si2176_TUNER_IEN_PROP_RSSIHIEN_LSB) & Si2176_TUNER_IEN_PROP_RSSIHIEN_MASK;
     break;
    #endif /*     Si2176_TUNER_IEN_PROP */
    #ifdef        Si2176_TUNER_INT_SENSE_PROP
     case         Si2176_TUNER_INT_SENSE_PROP_CODE:
               api->prop->tuner_int_sense.tcnegen    = (data >> Si2176_TUNER_INT_SENSE_PROP_TCNEGEN_LSB   ) & Si2176_TUNER_INT_SENSE_PROP_TCNEGEN_MASK;
               api->prop->tuner_int_sense.rssilnegen = (data >> Si2176_TUNER_INT_SENSE_PROP_RSSILNEGEN_LSB) & Si2176_TUNER_INT_SENSE_PROP_RSSILNEGEN_MASK;
               api->prop->tuner_int_sense.rssihnegen = (data >> Si2176_TUNER_INT_SENSE_PROP_RSSIHNEGEN_LSB) & Si2176_TUNER_INT_SENSE_PROP_RSSIHNEGEN_MASK;
               api->prop->tuner_int_sense.tcposen    = (data >> Si2176_TUNER_INT_SENSE_PROP_TCPOSEN_LSB   ) & Si2176_TUNER_INT_SENSE_PROP_TCPOSEN_MASK;
               api->prop->tuner_int_sense.rssilposen = (data >> Si2176_TUNER_INT_SENSE_PROP_RSSILPOSEN_LSB) & Si2176_TUNER_INT_SENSE_PROP_RSSILPOSEN_MASK;
               api->prop->tuner_int_sense.rssihposen = (data >> Si2176_TUNER_INT_SENSE_PROP_RSSIHPOSEN_LSB) & Si2176_TUNER_INT_SENSE_PROP_RSSIHPOSEN_MASK;
     break;
    #endif /*     Si2176_TUNER_INT_SENSE_PROP */
    #ifdef        Si2176_TUNER_LO_INJECTION_PROP
     case         Si2176_TUNER_LO_INJECTION_PROP_CODE:
               api->prop->tuner_lo_injection.band_1 = (data >> Si2176_TUNER_LO_INJECTION_PROP_BAND_1_LSB) & Si2176_TUNER_LO_INJECTION_PROP_BAND_1_MASK;
               api->prop->tuner_lo_injection.band_2 = (data >> Si2176_TUNER_LO_INJECTION_PROP_BAND_2_LSB) & Si2176_TUNER_LO_INJECTION_PROP_BAND_2_MASK;
               api->prop->tuner_lo_injection.band_3 = (data >> Si2176_TUNER_LO_INJECTION_PROP_BAND_3_LSB) & Si2176_TUNER_LO_INJECTION_PROP_BAND_3_MASK;
               api->prop->tuner_lo_injection.band_4 = (data >> Si2176_TUNER_LO_INJECTION_PROP_BAND_4_LSB) & Si2176_TUNER_LO_INJECTION_PROP_BAND_4_MASK;
               api->prop->tuner_lo_injection.band_5 = (data >> Si2176_TUNER_LO_INJECTION_PROP_BAND_5_LSB) & Si2176_TUNER_LO_INJECTION_PROP_BAND_5_MASK;
     break;
    #endif /*     Si2176_TUNER_LO_INJECTION_PROP */
   default : break;
    }
...
/* _get_property_string_insertion_start */
  ...
  /* --------------------------------------------*/
unsigned char Si2176_L1_GetPropertyString(L1_Si2176_Context *api, unsigned int prop_code, char *separator, char *msg) {
    int res;
    res = Si2176_L1_GetProperty2(api,prop_code);
    if (res!=NO_Si2176_ERROR) { sprintf(msg, "%s",Si2176_L1_API_ERROR_TEXT(res)); return res; }
    Si2176_L1_FillPropertyStringText(api, prop_code, separator, msg);
    return NO_Si2176_ERROR;
}
  /* --------------------------------------------*/
  /* FillPropertyStringText FUNCTION             */
  /* --------------------------------------------*/
void          Si2176_L1_FillPropertyStringText(L1_Si2176_Context *api, unsigned int prop_code, char *separator, char *msg) {
    switch (prop_code) {
    #ifdef        Si2176_ATV_AFC_RANGE_PROP
     case         Si2176_ATV_AFC_RANGE_PROP_CODE:
