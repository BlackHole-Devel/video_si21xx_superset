...
/*************************************************************************************
   ...
   FILE: Si2176_L1_API.h
   Supported IC : Si2176
   Compiled for ROM 13 firmware 3_2_build_6
   Revision: 0.1
   Date: December 22 2011
**************************************************************************************/
#ifndef    _Si2176_L1_API_H_
#define    _Si2176_L1_API_H_
...
/* define PART_INTEGRITY_CHECKS (here) and the expected part number, chip rev, pmajor, pminor, and romid (in Si2176_L1_API.c) to use integrity checking */
#undef PART_INTEGRITY_CHECKS
/* chip rev constants for integrity checking */
extern const char Si2176_chiprev;
extern const char Si2176_part;
extern const char Si2176_partMajorVersion;
extern const char Si2176_partMinorVersion;
extern const char Si2176_partRomid;
...
char*         Si2176_L1_API_TAG_TEXT  (void);

#define Si2176_TAG Si2176_L1_API_TAG_TEXT
