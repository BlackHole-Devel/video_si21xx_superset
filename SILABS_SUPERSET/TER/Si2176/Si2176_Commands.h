...
#define   Si2176_AGC_OVERRIDE_CMD 0x44
  ...
  #define Si2176_AGC_OVERRIDE_CMD_CODE 0x010044
...
#define   Si2176_ATV_RESTART_CMD 0x51
  ...
  #define Si2176_ATV_RESTART_CMD_CODE 0x010051
...
#define   Si2176_ATV_STATUS_CMD 0x52
  ...
  #define Si2176_ATV_STATUS_CMD_CODE 0x010052
   ...
   #define  Si2176_ATV_STATUS_RESPONSE_AUDIO_SYS_MASK        0x0f
    ...
    #define Si2176_ATV_STATUS_RESPONSE_AUDIO_SYS_MONO_NICAM_10DB  12
    #define Si2176_ATV_STATUS_RESPONSE_AUDIO_SYS_MONO_NICAM_6DB   11
...
#define   Si2176_CONFIG_PINS_CMD 0x12
  ...
  #define Si2176_CONFIG_PINS_CMD_CODE 0x010012
...
#define   Si2176_DTV_RESTART_CMD 0x61
  ...
  #define Si2176_DTV_RESTART_CMD_CODE 0x010061
...
#define   Si2176_DTV_STATUS_CMD 0x62
  ...
  #define Si2176_DTV_STATUS_CMD_CODE 0x010062
...
#define   Si2176_EXIT_BOOTLOADER_CMD 0x01
  ...
  #define Si2176_EXIT_BOOTLOADER_CMD_CODE 0x010001
...
#define   Si2176_FINE_TUNE_CMD 0x45
  ...
  #define Si2176_FINE_TUNE_CMD_CODE 0x010045
   ...
   #define  Si2176_FINE_TUNE_CMD_PERSISTENCE_LSB         0
   #define  Si2176_FINE_TUNE_CMD_PERSISTENCE_MASK        0x01
   #define  Si2176_FINE_TUNE_CMD_PERSISTENCE_MIN         0
   #define  Si2176_FINE_TUNE_CMD_PERSISTENCE_MAX         1
    #define Si2176_FINE_TUNE_CMD_PERSISTENCE_NON_PERSISTENT  0
    #define Si2176_FINE_TUNE_CMD_PERSISTENCE_PERSISTENT      1
...
#define   Si2176_GET_PROPERTY_CMD 0x15
  ...
  #define Si2176_GET_PROPERTY_CMD_CODE 0x010015
...
#define   Si2176_GET_REV_CMD 0x11
  ...
  #define Si2176_GET_REV_CMD_CODE 0x010011
...
#define   Si2176_PART_INFO_CMD 0x02
  ...
  #define Si2176_PART_INFO_CMD_CODE 0x010002
...
#define   Si2176_POWER_DOWN_CMD 0x13
  ...
  #define Si2176_POWER_DOWN_CMD_CODE 0x010013
...
#define   Si2176_POWER_UP_CMD 0xc0
  ...
  #define Si2176_POWER_UP_CMD_CODE 0x0100c0
...
#define   Si2176_SET_PROPERTY_CMD 0x14
  ...
  #define Si2176_SET_PROPERTY_CMD_CODE 0x010014
...
#define   Si2176_STANDBY_CMD 0x16
  ...
  #define Si2176_STANDBY_CMD_CODE 0x010016
   ...
   #define  Si2176_STANDBY_CMD_TYPE_LSB         0
   #define  Si2176_STANDBY_CMD_TYPE_MASK        0x01
   #define  Si2176_STANDBY_CMD_TYPE_MIN         0
   #define  Si2176_STANDBY_CMD_TYPE_MAX         1
    #define Si2176_STANDBY_CMD_TYPE_LNA_OFF  1
    #define Si2176_STANDBY_CMD_TYPE_NORMAL   0
...
#define   Si2176_TUNER_STATUS_CMD 0x42
  ...
  #define Si2176_TUNER_STATUS_CMD_CODE 0x010042
...
#define   Si2176_TUNER_TUNE_FREQ_CMD 0x41
  ...
  #define Si2176_TUNER_TUNE_FREQ_CMD_CODE 0x010041
   ...
   #define  Si2176_TUNER_TUNE_FREQ_CMD_FREQ_MIN         40000000
   #define  Si2176_TUNER_TUNE_FREQ_CMD_FREQ_MAX         1002000000
    #define Si2176_TUNER_TUNE_FREQ_CMD_FREQ_FREQ_MIN  40000000
...
/* _commands_struct_insertion_start */
  ...
  /* --------------------------------------------*/
  typedef struct { /* Si2176_CmdObj struct */
    #ifdef    Si2176_AGC_OVERRIDE_CMD
...
#define   Si2176_GET_COMMAND_STRINGS
