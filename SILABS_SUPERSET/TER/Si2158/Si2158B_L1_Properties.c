...
/***********************************************************************************************************************
  ...
  Behavior:  This function will only download the property if required.
               Conditions to download the property are:
                ...
                - The propertyWriteMode is set to Si2158B_DOWNLOAD_ALWAYS
                - The property is unknown to Si2158B_PackProperty (this may be useful for debug purpose)
  Returns:    0 if no error, an error code otherwise
 ***********************************************************************************************************************/
unsigned char Si2158B_L1_SetProperty         (L1_Si2158B_Context *api, unsigned int prop_code, int  data) {
    unsigned char  reserved=0;
    return Si2158B_L1_SET_PROPERTY (api, reserved, prop_code, data);
}
/***********************************************************************************************************************
  Si2158B_L1_GetProperty function
  ...
  Returns:    0 if no error, an error code otherwise
 ***********************************************************************************************************************/
unsigned char Si2158B_L1_GetProperty         (L1_Si2158B_Context *api, unsigned int prop_code, int *data) {
    unsigned char  reserved          = 0;
    unsigned char res;
    res = Si2158B_L1_GET_PROPERTY (api, reserved, prop_code);
    *data = api->rsp->get_property.data;
    return res;
}
/***********************************************************************************************************************
  Si2158B_L1_SetProperty2 function
  Use:        Sets the property given the property code.
  Parameter: *api     the Si2158B context
  Parameter: prop     the property Id

  Returns:    NO_Si2158B_ERROR if successful.
 ***********************************************************************************************************************/
unsigned char Si2158B_L1_SetProperty2(L1_Si2158B_Context *api, unsigned int prop_code) {
    int data, res;
    char msg[1000];
    res = Si2158B_PackProperty(api->prop, prop_code, &data);
    if (res != NO_Si2158B_ERROR) {
      sprintf(msg, "\nSi2158B_L1_SetProperty2: %s 0x%04x!\n\n", Si2158B_L1_API_ERROR_TEXT(res), prop_code);
      SiTRACE(msg);
      SiERROR(msg);
      return res;
    }
    return Si2158B_L1_SetProperty (api, prop_code & 0xffff, data);
  }
/***********************************************************************************************************************
  Si2158B_L1_GetProperty2 function
  Use:        property get function
              Used to call L1_GET_PROPERTY with the property Id provided.
  Parameter: *api     the Si2158B context
  Parameter: prop     the property Id
  ...
  Returns:    NO_Si2158B_ERROR if successful.
 ***********************************************************************************************************************/
unsigned char Si2158B_L1_GetProperty2        (L1_Si2158B_Context *api, unsigned int prop_code) {
  int data, res;
  res = Si2158B_L1_GetProperty(api, prop_code & 0xffff, &data);
  if (res != NO_Si2158B_ERROR) {
    SiTRACE("Si2158B_L1_GetProperty2: %s 0x%04x\n", Si2158B_L1_API_ERROR_TEXT(res), prop_code);
    SiERROR(Si2158B_L1_API_ERROR_TEXT(res));
    return res;
  }
  return Si2158B_UnpackProperty(api->prop, prop_code, data);
}
/*****************************************************************************************
 NAME: Si2158B_downloadATVProperties
  DESCRIPTION: Setup Si2158B ATV properties configuration
  This function will download all the ATV configuration properties.
  The function Si2158B_storeUserProperties should be called before the first call to this function.
...
int  Si2158B_downloadATVProperties         (L1_Si2158B_Context *api) {
  SiTRACE("Si2158B_downloadATVProperties\n");
#ifdef    Si2158B_ATV_AFC_RANGE_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_AFC_RANGE_PROP_CODE               ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_AFC_RANGE_PROP */
#ifdef    Si2158B_ATV_AGC_SPEED_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_AGC_SPEED_PROP_CODE               ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_AGC_SPEED_PROP */
#ifdef    Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_CODE      ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP */
#ifdef    Si2158B_ATV_ARTIFICIAL_SNOW_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_ARTIFICIAL_SNOW_PROP_CODE         ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_ARTIFICIAL_SNOW_PROP */
#ifdef    Si2158B_ATV_CONFIG_IF_PORT_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_CONFIG_IF_PORT_PROP_CODE          ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_CONFIG_IF_PORT_PROP */
#ifdef    Si2158B_ATV_EXT_AGC_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_EXT_AGC_PROP_CODE                 ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_EXT_AGC_PROP */
#ifdef    Si2158B_ATV_HSYNC_OUT_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_HSYNC_OUT_PROP_CODE               ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_HSYNC_OUT_PROP */
#ifdef    Si2158B_ATV_IEN_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_IEN_PROP_CODE                     ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_IEN_PROP */
#ifdef    Si2158B_ATV_INT_SENSE_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_INT_SENSE_PROP_CODE               ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_INT_SENSE_PROP */
#ifdef    Si2158B_ATV_LIF_FREQ_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_LIF_FREQ_PROP_CODE                ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_LIF_FREQ_PROP */
#ifdef    Si2158B_ATV_LIF_OUT_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_LIF_OUT_PROP_CODE                 ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_LIF_OUT_PROP */
#ifdef    Si2158B_ATV_PGA_TARGET_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_PGA_TARGET_PROP_CODE              ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_PGA_TARGET_PROP */
#ifdef    Si2158B_ATV_RF_TOP_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_RF_TOP_PROP_CODE                  ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_RF_TOP_PROP */
#ifdef    Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_CODE      ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP */
#ifdef    Si2158B_ATV_VIDEO_MODE_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_VIDEO_MODE_PROP_CODE              ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_VIDEO_MODE_PROP */
#ifdef    Si2158B_ATV_VSNR_CAP_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_ATV_VSNR_CAP_PROP_CODE                ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_ATV_VSNR_CAP_PROP */
return NO_Si2158B_ERROR;
}
/*****************************************************************************************
 NAME: Si2158B_downloadCOMMONProperties
  DESCRIPTION: Setup Si2158B COMMON properties configuration
...
int  Si2158B_downloadCOMMONProperties      (L1_Si2158B_Context *api) {
  SiTRACE("Si2158B_downloadCOMMONProperties\n");
#ifdef    Si2158B_CRYSTAL_TRIM_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_CRYSTAL_TRIM_PROP_CODE                ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_CRYSTAL_TRIM_PROP */
#ifdef    Si2158B_MASTER_IEN_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_MASTER_IEN_PROP_CODE                  ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_MASTER_IEN_PROP */
#ifdef    Si2158B_XOUT_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_XOUT_PROP_CODE                        ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_XOUT_PROP */
return NO_Si2158B_ERROR;
}
/*****************************************************************************************
 NAME: Si2158B_downloadDTVProperties
  DESCRIPTION: Setup Si2158B DTV properties configuration
...
int  Si2158B_downloadDTVProperties         (L1_Si2158B_Context *api) {
  SiTRACE("Si2158B_downloadDTVProperties\n");
#ifdef    Si2158B_DTV_AGC_AUTO_FREEZE_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_AGC_AUTO_FREEZE_PROP_CODE         ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_AGC_AUTO_FREEZE_PROP */
#ifdef    Si2158B_DTV_AGC_FREEZE_INPUT_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_AGC_FREEZE_INPUT_PROP_CODE        ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_AGC_FREEZE_INPUT_PROP */
#ifdef    Si2158B_DTV_AGC_SPEED_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_AGC_SPEED_PROP_CODE               ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_AGC_SPEED_PROP */
#ifdef    Si2158B_DTV_CONFIG_IF_PORT_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_CONFIG_IF_PORT_PROP_CODE          ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_CONFIG_IF_PORT_PROP */
#ifdef    Si2158B_DTV_EXT_AGC_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_EXT_AGC_PROP_CODE                 ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_EXT_AGC_PROP */
#ifdef    Si2158B_DTV_IEN_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_IEN_PROP_CODE                     ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_IEN_PROP */
#ifdef    Si2158B_DTV_IF_AGC_SPEED_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_IF_AGC_SPEED_PROP_CODE            ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_IF_AGC_SPEED_PROP */
#ifdef    Si2158B_DTV_INITIAL_AGC_SPEED_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_INITIAL_AGC_SPEED_PROP_CODE       ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_INITIAL_AGC_SPEED_PROP */
#ifdef    Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_CODE) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP */
#ifdef    Si2158B_DTV_INTERNAL_ZIF_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_INTERNAL_ZIF_PROP_CODE            ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_INTERNAL_ZIF_PROP */
#ifdef    Si2158B_DTV_INT_SENSE_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_INT_SENSE_PROP_CODE               ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_INT_SENSE_PROP */
#ifdef    Si2158B_DTV_LIF_FREQ_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_LIF_FREQ_PROP_CODE                ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_LIF_FREQ_PROP */
#ifdef    Si2158B_DTV_LIF_OUT_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_LIF_OUT_PROP_CODE                 ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_LIF_OUT_PROP */
#ifdef    Si2158B_DTV_MODE_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_MODE_PROP_CODE                    ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_MODE_PROP */
#ifdef    Si2158B_DTV_PGA_LIMITS_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_PGA_LIMITS_PROP_CODE              ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_PGA_LIMITS_PROP */
#ifdef    Si2158B_DTV_PGA_TARGET_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_PGA_TARGET_PROP_CODE              ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_PGA_TARGET_PROP */
#ifdef    Si2158B_DTV_RF_AGC_SPEED_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_RF_AGC_SPEED_PROP_CODE            ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_RF_AGC_SPEED_PROP */
#ifdef    Si2158B_DTV_RF_TOP_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_RF_TOP_PROP_CODE                  ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_RF_TOP_PROP */
#ifdef    Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_CODE      ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP */
#ifdef    Si2158B_DTV_WB_AGC_SPEED_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_WB_AGC_SPEED_PROP_CODE            ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_WB_AGC_SPEED_PROP */
#ifdef    Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP_CODE     ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP */
return NO_Si2158B_ERROR;
}
/*****************************************************************************************
 NAME: Si2158B_downloadTUNERProperties
  DESCRIPTION: Setup Si2158B TUNER properties configuration
...
int  Si2158B_downloadTUNERProperties       (L1_Si2158B_Context *api) {
  SiTRACE("Si2158B_downloadTUNERProperties\n");
#ifdef    Si2158B_TUNER_BLOCKED_VCO_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_TUNER_BLOCKED_VCO_PROP_CODE           ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_TUNER_BLOCKED_VCO_PROP */
#ifdef    Si2158B_TUNER_IEN_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_TUNER_IEN_PROP_CODE                   ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_TUNER_IEN_PROP */
#ifdef    Si2158B_TUNER_INT_SENSE_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_TUNER_INT_SENSE_PROP_CODE             ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_TUNER_INT_SENSE_PROP */
#ifdef    Si2158B_TUNER_LO_INJECTION_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_TUNER_LO_INJECTION_PROP_CODE          ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_TUNER_LO_INJECTION_PROP */
#ifdef    Si2158B_TUNER_RETURN_LOSS_PROP
  if (Si2158B_L1_SetProperty2(api, Si2158B_TUNER_RETURN_LOSS_PROP_CODE           ) != NO_Si2158B_ERROR) {return ERROR_Si2158B_SENDING_COMMAND;}
#endif /* Si2158B_TUNER_RETURN_LOSS_PROP */
return NO_Si2158B_ERROR;
}
int  Si2158B_downloadAllProperties         (L1_Si2158B_Context *api) {
  Si2158B_downloadATVProperties         (api);
  Si2158B_downloadCOMMONProperties      (api);
  Si2158B_downloadDTVProperties         (api);
  Si2158B_downloadTUNERProperties       (api);
  return 0;
}

/***********************************************************************************************************************
  Si2158B_PackProperty function
  Use:        This function will pack all the members of a property into an integer for the SetProperty function.

  Parameter: *prop          the Si2158B property context
  Parameter:  prop_code     the property Id
  Parameter:  *data         an int to store the property data

  Returns:    NO_Si2158B_ERROR if the property exists.
 ***********************************************************************************************************************/
unsigned char Si2158B_PackProperty            (Si2158B_PropObj   *prop, unsigned int prop_code, int *data) {
    switch (prop_code) {
    #ifdef        Si2158B_ATV_AFC_RANGE_PROP
     case         Si2158B_ATV_AFC_RANGE_PROP_CODE:
      *data = (prop->atv_afc_range.range_khz & Si2158B_ATV_AFC_RANGE_PROP_RANGE_KHZ_MASK) << Si2158B_ATV_AFC_RANGE_PROP_RANGE_KHZ_LSB ;
     break;
    #endif /*     Si2158B_ATV_AFC_RANGE_PROP */
    #ifdef        Si2158B_ATV_AGC_SPEED_PROP
     case         Si2158B_ATV_AGC_SPEED_PROP_CODE:
      *data = (prop->atv_agc_speed.if_agc_speed & Si2158B_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK) << Si2158B_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB ;
     break;
    #endif /*     Si2158B_ATV_AGC_SPEED_PROP */
    #ifdef        Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP
     case         Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_CODE:
      *data = (prop->atv_agc_speed_low_rssi.if_agc_speed & Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_MASK) << Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_LSB  |
              (prop->atv_agc_speed_low_rssi.thld         & Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_MASK        ) << Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_LSB ;
     break;
    #endif /*     Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP */
    #ifdef        Si2158B_ATV_ARTIFICIAL_SNOW_PROP
     case         Si2158B_ATV_ARTIFICIAL_SNOW_PROP_CODE:
      *data = (prop->atv_artificial_snow.gain   & Si2158B_ATV_ARTIFICIAL_SNOW_PROP_GAIN_MASK  ) << Si2158B_ATV_ARTIFICIAL_SNOW_PROP_GAIN_LSB  |
              (prop->atv_artificial_snow.period & Si2158B_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_MASK) << Si2158B_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_LSB  |
              (prop->atv_artificial_snow.offset & Si2158B_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_MASK) << Si2158B_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_LSB ;
     break;
    #endif /*     Si2158B_ATV_ARTIFICIAL_SNOW_PROP */
    #ifdef        Si2158B_ATV_CONFIG_IF_PORT_PROP
     case         Si2158B_ATV_CONFIG_IF_PORT_PROP_CODE:
      *data = (prop->atv_config_if_port.atv_out_type   & Si2158B_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_MASK  ) << Si2158B_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LSB  |
              (prop->atv_config_if_port.atv_agc_source & Si2158B_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_MASK) << Si2158B_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_LSB ;
     break;
    #endif /*     Si2158B_ATV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2158B_ATV_EXT_AGC_PROP
     case         Si2158B_ATV_EXT_AGC_PROP_CODE:
      *data = (prop->atv_ext_agc.min_10mv & Si2158B_ATV_EXT_AGC_PROP_MIN_10MV_MASK) << Si2158B_ATV_EXT_AGC_PROP_MIN_10MV_LSB  |
              (prop->atv_ext_agc.max_10mv & Si2158B_ATV_EXT_AGC_PROP_MAX_10MV_MASK) << Si2158B_ATV_EXT_AGC_PROP_MAX_10MV_LSB ;
     break;
    #endif /*     Si2158B_ATV_EXT_AGC_PROP */
    #ifdef        Si2158B_ATV_HSYNC_OUT_PROP
     case         Si2158B_ATV_HSYNC_OUT_PROP_CODE:
      *data = (prop->atv_hsync_out.gpio_sel & Si2158B_ATV_HSYNC_OUT_PROP_GPIO_SEL_MASK) << Si2158B_ATV_HSYNC_OUT_PROP_GPIO_SEL_LSB  |
              (prop->atv_hsync_out.width    & Si2158B_ATV_HSYNC_OUT_PROP_WIDTH_MASK   ) << Si2158B_ATV_HSYNC_OUT_PROP_WIDTH_LSB  |
              (prop->atv_hsync_out.offset   & Si2158B_ATV_HSYNC_OUT_PROP_OFFSET_MASK  ) << Si2158B_ATV_HSYNC_OUT_PROP_OFFSET_LSB ;
     break;
    #endif /*     Si2158B_ATV_HSYNC_OUT_PROP */
    #ifdef        Si2158B_ATV_IEN_PROP
     case         Si2158B_ATV_IEN_PROP_CODE:
      *data = (prop->atv_ien.chlien & Si2158B_ATV_IEN_PROP_CHLIEN_MASK) << Si2158B_ATV_IEN_PROP_CHLIEN_LSB  |
              (prop->atv_ien.pclien & Si2158B_ATV_IEN_PROP_PCLIEN_MASK) << Si2158B_ATV_IEN_PROP_PCLIEN_LSB ;
     break;
    #endif /*     Si2158B_ATV_IEN_PROP */
    #ifdef        Si2158B_ATV_INT_SENSE_PROP
     case         Si2158B_ATV_INT_SENSE_PROP_CODE:
      *data = (prop->atv_int_sense.chlnegen & Si2158B_ATV_INT_SENSE_PROP_CHLNEGEN_MASK) << Si2158B_ATV_INT_SENSE_PROP_CHLNEGEN_LSB  |
              (prop->atv_int_sense.pclnegen & Si2158B_ATV_INT_SENSE_PROP_PCLNEGEN_MASK) << Si2158B_ATV_INT_SENSE_PROP_PCLNEGEN_LSB  |
              (prop->atv_int_sense.chlposen & Si2158B_ATV_INT_SENSE_PROP_CHLPOSEN_MASK) << Si2158B_ATV_INT_SENSE_PROP_CHLPOSEN_LSB  |
              (prop->atv_int_sense.pclposen & Si2158B_ATV_INT_SENSE_PROP_PCLPOSEN_MASK) << Si2158B_ATV_INT_SENSE_PROP_PCLPOSEN_LSB ;
     break;
    #endif /*     Si2158B_ATV_INT_SENSE_PROP */
    #ifdef        Si2158B_ATV_LIF_FREQ_PROP
     case         Si2158B_ATV_LIF_FREQ_PROP_CODE:
      *data = (prop->atv_lif_freq.offset & Si2158B_ATV_LIF_FREQ_PROP_OFFSET_MASK) << Si2158B_ATV_LIF_FREQ_PROP_OFFSET_LSB ;
     break;
    #endif /*     Si2158B_ATV_LIF_FREQ_PROP */
    #ifdef        Si2158B_ATV_LIF_OUT_PROP
     case         Si2158B_ATV_LIF_OUT_PROP_CODE:
      *data = (prop->atv_lif_out.offset & Si2158B_ATV_LIF_OUT_PROP_OFFSET_MASK) << Si2158B_ATV_LIF_OUT_PROP_OFFSET_LSB  |
              (prop->atv_lif_out.amp    & Si2158B_ATV_LIF_OUT_PROP_AMP_MASK   ) << Si2158B_ATV_LIF_OUT_PROP_AMP_LSB ;
     break;
    #endif /*     Si2158B_ATV_LIF_OUT_PROP */
    #ifdef        Si2158B_ATV_PGA_TARGET_PROP
     case         Si2158B_ATV_PGA_TARGET_PROP_CODE:
      *data = (prop->atv_pga_target.pga_target      & Si2158B_ATV_PGA_TARGET_PROP_PGA_TARGET_MASK     ) << Si2158B_ATV_PGA_TARGET_PROP_PGA_TARGET_LSB  |
              (prop->atv_pga_target.override_enable & Si2158B_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK) << Si2158B_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB ;
     break;
    #endif /*     Si2158B_ATV_PGA_TARGET_PROP */
    #ifdef        Si2158B_ATV_RF_TOP_PROP
     case         Si2158B_ATV_RF_TOP_PROP_CODE:
      *data = (prop->atv_rf_top.atv_rf_top & Si2158B_ATV_RF_TOP_PROP_ATV_RF_TOP_MASK) << Si2158B_ATV_RF_TOP_PROP_ATV_RF_TOP_LSB ;
     break;
    #endif /*     Si2158B_ATV_RF_TOP_PROP */
    #ifdef        Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_CODE:
      *data = (prop->atv_rsq_rssi_threshold.lo & Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK) << Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB  |
              (prop->atv_rsq_rssi_threshold.hi & Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK) << Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB ;
     break;
    #endif /*     Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2158B_ATV_VIDEO_MODE_PROP
     case         Si2158B_ATV_VIDEO_MODE_PROP_CODE:
      *data = (prop->atv_video_mode.video_sys       & Si2158B_ATV_VIDEO_MODE_PROP_VIDEO_SYS_MASK      ) << Si2158B_ATV_VIDEO_MODE_PROP_VIDEO_SYS_LSB  |
              (prop->atv_video_mode.color           & Si2158B_ATV_VIDEO_MODE_PROP_COLOR_MASK          ) << Si2158B_ATV_VIDEO_MODE_PROP_COLOR_LSB  |
              (prop->atv_video_mode.invert_spectrum & Si2158B_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_MASK) << Si2158B_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_LSB ;
     break;
    #endif /*     Si2158B_ATV_VIDEO_MODE_PROP */
    #ifdef        Si2158B_ATV_VSNR_CAP_PROP
     case         Si2158B_ATV_VSNR_CAP_PROP_CODE:
      *data = (prop->atv_vsnr_cap.atv_vsnr_cap & Si2158B_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_MASK) << Si2158B_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_LSB ;
     break;
    #endif /*     Si2158B_ATV_VSNR_CAP_PROP */
    #ifdef        Si2158B_CRYSTAL_TRIM_PROP
     case         Si2158B_CRYSTAL_TRIM_PROP_CODE:
      *data = (prop->crystal_trim.xo_cap & Si2158B_CRYSTAL_TRIM_PROP_XO_CAP_MASK) << Si2158B_CRYSTAL_TRIM_PROP_XO_CAP_LSB ;
     break;
    #endif /*     Si2158B_CRYSTAL_TRIM_PROP */
    #ifdef        Si2158B_DTV_AGC_AUTO_FREEZE_PROP
     case         Si2158B_DTV_AGC_AUTO_FREEZE_PROP_CODE:
      *data = (prop->dtv_agc_auto_freeze.thld    & Si2158B_DTV_AGC_AUTO_FREEZE_PROP_THLD_MASK   ) << Si2158B_DTV_AGC_AUTO_FREEZE_PROP_THLD_LSB  |
              (prop->dtv_agc_auto_freeze.timeout & Si2158B_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_MASK) << Si2158B_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_LSB ;
     break;
    #endif /*     Si2158B_DTV_AGC_AUTO_FREEZE_PROP */
    #ifdef        Si2158B_DTV_AGC_FREEZE_INPUT_PROP
     case         Si2158B_DTV_AGC_FREEZE_INPUT_PROP_CODE:
      *data = (prop->dtv_agc_freeze_input.level & Si2158B_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_MASK) << Si2158B_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_LSB  |
              (prop->dtv_agc_freeze_input.pin   & Si2158B_DTV_AGC_FREEZE_INPUT_PROP_PIN_MASK  ) << Si2158B_DTV_AGC_FREEZE_INPUT_PROP_PIN_LSB ;
     break;
    #endif /*     Si2158B_DTV_AGC_FREEZE_INPUT_PROP */
    #ifdef        Si2158B_DTV_AGC_SPEED_PROP
     case         Si2158B_DTV_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_agc_speed.if_agc_speed & Si2158B_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK) << Si2158B_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB  |
              (prop->dtv_agc_speed.agc_decim    & Si2158B_DTV_AGC_SPEED_PROP_AGC_DECIM_MASK   ) << Si2158B_DTV_AGC_SPEED_PROP_AGC_DECIM_LSB ;
     break;
    #endif /*     Si2158B_DTV_AGC_SPEED_PROP */
    #ifdef        Si2158B_DTV_CONFIG_IF_PORT_PROP
     case         Si2158B_DTV_CONFIG_IF_PORT_PROP_CODE:
      *data = (prop->dtv_config_if_port.dtv_out_type   & Si2158B_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_MASK  ) << Si2158B_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_LSB  |
              (prop->dtv_config_if_port.dtv_agc_source & Si2158B_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_MASK) << Si2158B_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_LSB ;
     break;
    #endif /*     Si2158B_DTV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2158B_DTV_EXT_AGC_PROP
     case         Si2158B_DTV_EXT_AGC_PROP_CODE:
      *data = (prop->dtv_ext_agc.min_10mv & Si2158B_DTV_EXT_AGC_PROP_MIN_10MV_MASK) << Si2158B_DTV_EXT_AGC_PROP_MIN_10MV_LSB  |
              (prop->dtv_ext_agc.max_10mv & Si2158B_DTV_EXT_AGC_PROP_MAX_10MV_MASK) << Si2158B_DTV_EXT_AGC_PROP_MAX_10MV_LSB ;
     break;
    #endif /*     Si2158B_DTV_EXT_AGC_PROP */
    #ifdef        Si2158B_DTV_IEN_PROP
     case         Si2158B_DTV_IEN_PROP_CODE:
      *data = (prop->dtv_ien.chlien & Si2158B_DTV_IEN_PROP_CHLIEN_MASK) << Si2158B_DTV_IEN_PROP_CHLIEN_LSB ;
     break;
    #endif /*     Si2158B_DTV_IEN_PROP */
    #ifdef        Si2158B_DTV_IF_AGC_SPEED_PROP
     case         Si2158B_DTV_IF_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_if_agc_speed.attack & Si2158B_DTV_IF_AGC_SPEED_PROP_ATTACK_MASK) << Si2158B_DTV_IF_AGC_SPEED_PROP_ATTACK_LSB  |
              (prop->dtv_if_agc_speed.decay  & Si2158B_DTV_IF_AGC_SPEED_PROP_DECAY_MASK ) << Si2158B_DTV_IF_AGC_SPEED_PROP_DECAY_LSB ;
     break;
    #endif /*     Si2158B_DTV_IF_AGC_SPEED_PROP */
    #ifdef        Si2158B_DTV_INITIAL_AGC_SPEED_PROP
     case         Si2158B_DTV_INITIAL_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_initial_agc_speed.if_agc_speed & Si2158B_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_MASK) << Si2158B_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_LSB  |
              (prop->dtv_initial_agc_speed.agc_decim    & Si2158B_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_MASK   ) << Si2158B_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_LSB ;
     break;
    #endif /*     Si2158B_DTV_INITIAL_AGC_SPEED_PROP */
    #ifdef        Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP
     case         Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_CODE:
      *data = (prop->dtv_initial_agc_speed_period.period & Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_MASK) << Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_LSB ;
     break;
    #endif /*     Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP */
    #ifdef        Si2158B_DTV_INTERNAL_ZIF_PROP
     case         Si2158B_DTV_INTERNAL_ZIF_PROP_CODE:
      *data = (prop->dtv_internal_zif.atsc   & Si2158B_DTV_INTERNAL_ZIF_PROP_ATSC_MASK  ) << Si2158B_DTV_INTERNAL_ZIF_PROP_ATSC_LSB  |
              (prop->dtv_internal_zif.qam_us & Si2158B_DTV_INTERNAL_ZIF_PROP_QAM_US_MASK) << Si2158B_DTV_INTERNAL_ZIF_PROP_QAM_US_LSB  |
              (prop->dtv_internal_zif.dvbt   & Si2158B_DTV_INTERNAL_ZIF_PROP_DVBT_MASK  ) << Si2158B_DTV_INTERNAL_ZIF_PROP_DVBT_LSB  |
              (prop->dtv_internal_zif.dvbc   & Si2158B_DTV_INTERNAL_ZIF_PROP_DVBC_MASK  ) << Si2158B_DTV_INTERNAL_ZIF_PROP_DVBC_LSB  |
              (prop->dtv_internal_zif.isdbt  & Si2158B_DTV_INTERNAL_ZIF_PROP_ISDBT_MASK ) << Si2158B_DTV_INTERNAL_ZIF_PROP_ISDBT_LSB  |
              (prop->dtv_internal_zif.isdbc  & Si2158B_DTV_INTERNAL_ZIF_PROP_ISDBC_MASK ) << Si2158B_DTV_INTERNAL_ZIF_PROP_ISDBC_LSB  |
              (prop->dtv_internal_zif.dtmb   & Si2158B_DTV_INTERNAL_ZIF_PROP_DTMB_MASK  ) << Si2158B_DTV_INTERNAL_ZIF_PROP_DTMB_LSB ;
     break;
    #endif /*     Si2158B_DTV_INTERNAL_ZIF_PROP */
    #ifdef        Si2158B_DTV_INT_SENSE_PROP
     case         Si2158B_DTV_INT_SENSE_PROP_CODE:
      *data = (prop->dtv_int_sense.chlnegen & Si2158B_DTV_INT_SENSE_PROP_CHLNEGEN_MASK) << Si2158B_DTV_INT_SENSE_PROP_CHLNEGEN_LSB  |
              (prop->dtv_int_sense.chlposen & Si2158B_DTV_INT_SENSE_PROP_CHLPOSEN_MASK) << Si2158B_DTV_INT_SENSE_PROP_CHLPOSEN_LSB ;
     break;
    #endif /*     Si2158B_DTV_INT_SENSE_PROP */
    #ifdef        Si2158B_DTV_LIF_FREQ_PROP
     case         Si2158B_DTV_LIF_FREQ_PROP_CODE:
      *data = (prop->dtv_lif_freq.offset & Si2158B_DTV_LIF_FREQ_PROP_OFFSET_MASK) << Si2158B_DTV_LIF_FREQ_PROP_OFFSET_LSB ;
     break;
    #endif /*     Si2158B_DTV_LIF_FREQ_PROP */
    #ifdef        Si2158B_DTV_LIF_OUT_PROP
     case         Si2158B_DTV_LIF_OUT_PROP_CODE:
      *data = (prop->dtv_lif_out.offset & Si2158B_DTV_LIF_OUT_PROP_OFFSET_MASK) << Si2158B_DTV_LIF_OUT_PROP_OFFSET_LSB  |
              (prop->dtv_lif_out.amp    & Si2158B_DTV_LIF_OUT_PROP_AMP_MASK   ) << Si2158B_DTV_LIF_OUT_PROP_AMP_LSB ;
     break;
    #endif /*     Si2158B_DTV_LIF_OUT_PROP */
    #ifdef        Si2158B_DTV_MODE_PROP
     case         Si2158B_DTV_MODE_PROP_CODE:
      *data = (prop->dtv_mode.bw              & Si2158B_DTV_MODE_PROP_BW_MASK             ) << Si2158B_DTV_MODE_PROP_BW_LSB  |
              (prop->dtv_mode.modulation      & Si2158B_DTV_MODE_PROP_MODULATION_MASK     ) << Si2158B_DTV_MODE_PROP_MODULATION_LSB  |
              (prop->dtv_mode.invert_spectrum & Si2158B_DTV_MODE_PROP_INVERT_SPECTRUM_MASK) << Si2158B_DTV_MODE_PROP_INVERT_SPECTRUM_LSB ;
     break;
    #endif /*     Si2158B_DTV_MODE_PROP */
    #ifdef        Si2158B_DTV_PGA_LIMITS_PROP
     case         Si2158B_DTV_PGA_LIMITS_PROP_CODE:
      *data = (prop->dtv_pga_limits.min & Si2158B_DTV_PGA_LIMITS_PROP_MIN_MASK) << Si2158B_DTV_PGA_LIMITS_PROP_MIN_LSB  |
              (prop->dtv_pga_limits.max & Si2158B_DTV_PGA_LIMITS_PROP_MAX_MASK) << Si2158B_DTV_PGA_LIMITS_PROP_MAX_LSB ;
     break;
    #endif /*     Si2158B_DTV_PGA_LIMITS_PROP */
    #ifdef        Si2158B_DTV_PGA_TARGET_PROP
     case         Si2158B_DTV_PGA_TARGET_PROP_CODE:
      *data = (prop->dtv_pga_target.pga_target      & Si2158B_DTV_PGA_TARGET_PROP_PGA_TARGET_MASK     ) << Si2158B_DTV_PGA_TARGET_PROP_PGA_TARGET_LSB  |
              (prop->dtv_pga_target.override_enable & Si2158B_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK) << Si2158B_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB ;
     break;
    #endif /*     Si2158B_DTV_PGA_TARGET_PROP */
    #ifdef        Si2158B_DTV_RF_AGC_SPEED_PROP
     case         Si2158B_DTV_RF_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_rf_agc_speed.attack & Si2158B_DTV_RF_AGC_SPEED_PROP_ATTACK_MASK) << Si2158B_DTV_RF_AGC_SPEED_PROP_ATTACK_LSB  |
              (prop->dtv_rf_agc_speed.decay  & Si2158B_DTV_RF_AGC_SPEED_PROP_DECAY_MASK ) << Si2158B_DTV_RF_AGC_SPEED_PROP_DECAY_LSB ;
     break;
    #endif /*     Si2158B_DTV_RF_AGC_SPEED_PROP */
     #ifdef        Si2158B_DTV_RF_TOP_PROP
     case         Si2158B_DTV_RF_TOP_PROP_CODE:
      *data = (prop->dtv_rf_top.dtv_rf_top & Si2158B_DTV_RF_TOP_PROP_DTV_RF_TOP_MASK) << Si2158B_DTV_RF_TOP_PROP_DTV_RF_TOP_LSB ;
     break;
    #endif /*     Si2158B_DTV_RF_TOP_PROP */
    #ifdef        Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_CODE:
      *data = (prop->dtv_rsq_rssi_threshold.lo & Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK) << Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB  |
              (prop->dtv_rsq_rssi_threshold.hi & Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK) << Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB ;
     break;
    #endif /*     Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2158B_DTV_WB_AGC_SPEED_PROP
     case         Si2158B_DTV_WB_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_wb_agc_speed.attack & Si2158B_DTV_WB_AGC_SPEED_PROP_ATTACK_MASK) << Si2158B_DTV_WB_AGC_SPEED_PROP_ATTACK_LSB  |
              (prop->dtv_wb_agc_speed.decay  & Si2158B_DTV_WB_AGC_SPEED_PROP_DECAY_MASK ) << Si2158B_DTV_WB_AGC_SPEED_PROP_DECAY_LSB ;
     break;
    #endif /*     Si2158B_DTV_WB_AGC_SPEED_PROP */
    #ifdef        Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP
     case         Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP_CODE:
      *data = (prop->dtv_zif_dc_canceller_bw.bandwidth & Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP_BANDWIDTH_MASK) << Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP_BANDWIDTH_LSB ;
     break;
    #endif /*     Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP */
    #ifdef        Si2158B_MASTER_IEN_PROP
     case         Si2158B_MASTER_IEN_PROP_CODE:
      *data = (prop->master_ien.tunien & Si2158B_MASTER_IEN_PROP_TUNIEN_MASK) << Si2158B_MASTER_IEN_PROP_TUNIEN_LSB  |
              (prop->master_ien.atvien & Si2158B_MASTER_IEN_PROP_ATVIEN_MASK) << Si2158B_MASTER_IEN_PROP_ATVIEN_LSB  |
              (prop->master_ien.dtvien & Si2158B_MASTER_IEN_PROP_DTVIEN_MASK) << Si2158B_MASTER_IEN_PROP_DTVIEN_LSB  |
              (prop->master_ien.errien & Si2158B_MASTER_IEN_PROP_ERRIEN_MASK) << Si2158B_MASTER_IEN_PROP_ERRIEN_LSB  |
              (prop->master_ien.ctsien & Si2158B_MASTER_IEN_PROP_CTSIEN_MASK) << Si2158B_MASTER_IEN_PROP_CTSIEN_LSB ;
     break;
    #endif /*     Si2158B_MASTER_IEN_PROP */
    #ifdef        Si2158B_TUNER_BLOCKED_VCO_PROP
     case         Si2158B_TUNER_BLOCKED_VCO_PROP_CODE:
      *data = (prop->tuner_blocked_vco.vco_code & Si2158B_TUNER_BLOCKED_VCO_PROP_VCO_CODE_MASK) << Si2158B_TUNER_BLOCKED_VCO_PROP_VCO_CODE_LSB ;
     break;
    #endif /*     Si2158B_TUNER_BLOCKED_VCO_PROP */
    #ifdef        Si2158B_TUNER_IEN_PROP
     case         Si2158B_TUNER_IEN_PROP_CODE:
      *data = (prop->tuner_ien.tcien    & Si2158B_TUNER_IEN_PROP_TCIEN_MASK   ) << Si2158B_TUNER_IEN_PROP_TCIEN_LSB  |
              (prop->tuner_ien.rssilien & Si2158B_TUNER_IEN_PROP_RSSILIEN_MASK) << Si2158B_TUNER_IEN_PROP_RSSILIEN_LSB  |
              (prop->tuner_ien.rssihien & Si2158B_TUNER_IEN_PROP_RSSIHIEN_MASK) << Si2158B_TUNER_IEN_PROP_RSSIHIEN_LSB ;
     break;
    #endif /*     Si2158B_TUNER_IEN_PROP */
    #ifdef        Si2158B_TUNER_INT_SENSE_PROP
     case         Si2158B_TUNER_INT_SENSE_PROP_CODE:
      *data = (prop->tuner_int_sense.tcnegen    & Si2158B_TUNER_INT_SENSE_PROP_TCNEGEN_MASK   ) << Si2158B_TUNER_INT_SENSE_PROP_TCNEGEN_LSB  |
              (prop->tuner_int_sense.rssilnegen & Si2158B_TUNER_INT_SENSE_PROP_RSSILNEGEN_MASK) << Si2158B_TUNER_INT_SENSE_PROP_RSSILNEGEN_LSB  |
              (prop->tuner_int_sense.rssihnegen & Si2158B_TUNER_INT_SENSE_PROP_RSSIHNEGEN_MASK) << Si2158B_TUNER_INT_SENSE_PROP_RSSIHNEGEN_LSB  |
              (prop->tuner_int_sense.tcposen    & Si2158B_TUNER_INT_SENSE_PROP_TCPOSEN_MASK   ) << Si2158B_TUNER_INT_SENSE_PROP_TCPOSEN_LSB  |
              (prop->tuner_int_sense.rssilposen & Si2158B_TUNER_INT_SENSE_PROP_RSSILPOSEN_MASK) << Si2158B_TUNER_INT_SENSE_PROP_RSSILPOSEN_LSB  |
              (prop->tuner_int_sense.rssihposen & Si2158B_TUNER_INT_SENSE_PROP_RSSIHPOSEN_MASK) << Si2158B_TUNER_INT_SENSE_PROP_RSSIHPOSEN_LSB ;
     break;
    #endif /*     Si2158B_TUNER_INT_SENSE_PROP */
    #ifdef        Si2158B_TUNER_LO_INJECTION_PROP
     case         Si2158B_TUNER_LO_INJECTION_PROP_CODE:
      *data = (prop->tuner_lo_injection.band_1 & Si2158B_TUNER_LO_INJECTION_PROP_BAND_1_MASK) << Si2158B_TUNER_LO_INJECTION_PROP_BAND_1_LSB  |
              (prop->tuner_lo_injection.band_2 & Si2158B_TUNER_LO_INJECTION_PROP_BAND_2_MASK) << Si2158B_TUNER_LO_INJECTION_PROP_BAND_2_LSB  |
              (prop->tuner_lo_injection.band_3 & Si2158B_TUNER_LO_INJECTION_PROP_BAND_3_MASK) << Si2158B_TUNER_LO_INJECTION_PROP_BAND_3_LSB ;
     break;
    #endif /*     Si2158B_TUNER_LO_INJECTION_PROP */
    #ifdef        Si2158B_TUNER_RETURN_LOSS_PROP
     case         Si2158B_TUNER_RETURN_LOSS_PROP_CODE:
      *data = (prop->tuner_return_loss.config & Si2158B_TUNER_RETURN_LOSS_PROP_CONFIG_MASK) << Si2158B_TUNER_RETURN_LOSS_PROP_CONFIG_LSB  |
              (prop->tuner_return_loss.mode   & Si2158B_TUNER_RETURN_LOSS_PROP_MODE_MASK  ) << Si2158B_TUNER_RETURN_LOSS_PROP_MODE_LSB ;
     break;
    #endif /*     Si2158B_TUNER_RETURN_LOSS_PROP */
    #ifdef        Si2158B_XOUT_PROP
     case         Si2158B_XOUT_PROP_CODE:
      *data = (prop->xout.amp & Si2158B_XOUT_PROP_AMP_MASK) << Si2158B_XOUT_PROP_AMP_LSB ;
     break;
    #endif /*     Si2158B_XOUT_PROP */
     default : return ERROR_Si2158B_UNKNOWN_PROPERTY; break;
    }
    return NO_Si2158B_ERROR;
  }
...
/***********************************************************************************************************************
  Si2158B_UnpackProperty function
...
unsigned char Si2158B_UnpackProperty          (Si2158B_PropObj   *prop, unsigned int prop_code, int  data) {
    ...
    #ifdef        Si2158B_ATV_AFC_RANGE_PROP
     case         Si2158B_ATV_AFC_RANGE_PROP_CODE:
               prop->atv_afc_range.range_khz = (data >> Si2158B_ATV_AFC_RANGE_PROP_RANGE_KHZ_LSB) & Si2158B_ATV_AFC_RANGE_PROP_RANGE_KHZ_MASK;
     break;
    #endif /*     Si2158B_ATV_AFC_RANGE_PROP */
    #ifdef        Si2158B_ATV_AGC_SPEED_PROP
     case         Si2158B_ATV_AGC_SPEED_PROP_CODE:
               prop->atv_agc_speed.if_agc_speed     = (data >> Si2158B_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB    ) & Si2158B_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
     break;
    #endif /*     Si2158B_ATV_AGC_SPEED_PROP */
    #ifdef        Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP
     case         Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_CODE:
               prop->atv_agc_speed_low_rssi.if_agc_speed = (data >> Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_LSB) & Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_MASK;
               prop->atv_agc_speed_low_rssi.thld         = (data >> Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_LSB        ) & Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_MASK;
     break;
    #endif /*     Si2158B_ATV_AGC_SPEED_LOW_RSSI_PROP */
    #ifdef        Si2158B_ATV_ARTIFICIAL_SNOW_PROP
     case         Si2158B_ATV_ARTIFICIAL_SNOW_PROP_CODE:
               prop->atv_artificial_snow.gain   = (data >> Si2158B_ATV_ARTIFICIAL_SNOW_PROP_GAIN_LSB  ) & Si2158B_ATV_ARTIFICIAL_SNOW_PROP_GAIN_MASK;
               prop->atv_artificial_snow.period = (data >> Si2158B_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_LSB) & Si2158B_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_MASK;
               prop->atv_artificial_snow.offset = (data >> Si2158B_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_LSB) & Si2158B_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2158B_ATV_ARTIFICIAL_SNOW_PROP */
    #ifdef        Si2158B_ATV_CONFIG_IF_PORT_PROP
     case         Si2158B_ATV_CONFIG_IF_PORT_PROP_CODE:
               prop->atv_config_if_port.atv_out_type   = (data >> Si2158B_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LSB  ) & Si2158B_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_MASK;
               prop->atv_config_if_port.atv_agc_source = (data >> Si2158B_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_LSB) & Si2158B_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_MASK;
     break;
    #endif /*     Si2158B_ATV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2158B_ATV_EXT_AGC_PROP
     case         Si2158B_ATV_EXT_AGC_PROP_CODE:
               prop->atv_ext_agc.min_10mv = (data >> Si2158B_ATV_EXT_AGC_PROP_MIN_10MV_LSB) & Si2158B_ATV_EXT_AGC_PROP_MIN_10MV_MASK;
               prop->atv_ext_agc.max_10mv = (data >> Si2158B_ATV_EXT_AGC_PROP_MAX_10MV_LSB) & Si2158B_ATV_EXT_AGC_PROP_MAX_10MV_MASK;
     break;
    #endif /*     Si2158B_ATV_EXT_AGC_PROP */
    #ifdef        Si2158B_ATV_HSYNC_OUT_PROP
     case         Si2158B_ATV_HSYNC_OUT_PROP_CODE:
               prop->atv_hsync_out.gpio_sel = (data >> Si2158B_ATV_HSYNC_OUT_PROP_GPIO_SEL_LSB) & Si2158B_ATV_HSYNC_OUT_PROP_GPIO_SEL_MASK;
               prop->atv_hsync_out.width    = (data >> Si2158B_ATV_HSYNC_OUT_PROP_WIDTH_LSB   ) & Si2158B_ATV_HSYNC_OUT_PROP_WIDTH_MASK;
               prop->atv_hsync_out.offset   = (data >> Si2158B_ATV_HSYNC_OUT_PROP_OFFSET_LSB  ) & Si2158B_ATV_HSYNC_OUT_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2158B_ATV_HSYNC_OUT_PROP */
    #ifdef        Si2158B_ATV_IEN_PROP
     case         Si2158B_ATV_IEN_PROP_CODE:
               prop->atv_ien.chlien = (data >> Si2158B_ATV_IEN_PROP_CHLIEN_LSB) & Si2158B_ATV_IEN_PROP_CHLIEN_MASK;
               prop->atv_ien.pclien = (data >> Si2158B_ATV_IEN_PROP_PCLIEN_LSB) & Si2158B_ATV_IEN_PROP_PCLIEN_MASK;
     break;
    #endif /*     Si2158B_ATV_IEN_PROP */
    #ifdef        Si2158B_ATV_INT_SENSE_PROP
     case         Si2158B_ATV_INT_SENSE_PROP_CODE:
               prop->atv_int_sense.chlnegen = (data >> Si2158B_ATV_INT_SENSE_PROP_CHLNEGEN_LSB) & Si2158B_ATV_INT_SENSE_PROP_CHLNEGEN_MASK;
               prop->atv_int_sense.pclnegen = (data >> Si2158B_ATV_INT_SENSE_PROP_PCLNEGEN_LSB) & Si2158B_ATV_INT_SENSE_PROP_PCLNEGEN_MASK;
               prop->atv_int_sense.chlposen = (data >> Si2158B_ATV_INT_SENSE_PROP_CHLPOSEN_LSB) & Si2158B_ATV_INT_SENSE_PROP_CHLPOSEN_MASK;
               prop->atv_int_sense.pclposen = (data >> Si2158B_ATV_INT_SENSE_PROP_PCLPOSEN_LSB) & Si2158B_ATV_INT_SENSE_PROP_PCLPOSEN_MASK;
     break;
    #endif /*     Si2158B_ATV_INT_SENSE_PROP */
    #ifdef        Si2158B_ATV_LIF_FREQ_PROP
     case         Si2158B_ATV_LIF_FREQ_PROP_CODE:
               prop->atv_lif_freq.offset = (data >> Si2158B_ATV_LIF_FREQ_PROP_OFFSET_LSB) & Si2158B_ATV_LIF_FREQ_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2158B_ATV_LIF_FREQ_PROP */
    #ifdef        Si2158B_ATV_LIF_OUT_PROP
     case         Si2158B_ATV_LIF_OUT_PROP_CODE:
               prop->atv_lif_out.offset = (data >> Si2158B_ATV_LIF_OUT_PROP_OFFSET_LSB) & Si2158B_ATV_LIF_OUT_PROP_OFFSET_MASK;
               prop->atv_lif_out.amp    = (data >> Si2158B_ATV_LIF_OUT_PROP_AMP_LSB   ) & Si2158B_ATV_LIF_OUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2158B_ATV_LIF_OUT_PROP */
    #ifdef        Si2158B_ATV_PGA_TARGET_PROP
     case         Si2158B_ATV_PGA_TARGET_PROP_CODE:
               prop->atv_pga_target.pga_target      = (data >> Si2158B_ATV_PGA_TARGET_PROP_PGA_TARGET_LSB     ) & Si2158B_ATV_PGA_TARGET_PROP_PGA_TARGET_MASK;
               prop->atv_pga_target.override_enable = (data >> Si2158B_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB) & Si2158B_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK;
     break;
    #endif /*     Si2158B_ATV_PGA_TARGET_PROP */
    #ifdef        Si2158B_ATV_RF_TOP_PROP
     case         Si2158B_ATV_RF_TOP_PROP_CODE:
               prop->atv_rf_top.atv_rf_top = (data >> Si2158B_ATV_RF_TOP_PROP_ATV_RF_TOP_LSB) & Si2158B_ATV_RF_TOP_PROP_ATV_RF_TOP_MASK;
     break;
    #endif /*     Si2158B_ATV_RF_TOP_PROP */
    #ifdef        Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_CODE:
               prop->atv_rsq_rssi_threshold.lo = (data >> Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB) & Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK;
               prop->atv_rsq_rssi_threshold.hi = (data >> Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB) & Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK;
     break;
    #endif /*     Si2158B_ATV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2158B_ATV_VIDEO_MODE_PROP
     case         Si2158B_ATV_VIDEO_MODE_PROP_CODE:
               prop->atv_video_mode.video_sys       = (data >> Si2158B_ATV_VIDEO_MODE_PROP_VIDEO_SYS_LSB      ) & Si2158B_ATV_VIDEO_MODE_PROP_VIDEO_SYS_MASK;
               prop->atv_video_mode.color           = (data >> Si2158B_ATV_VIDEO_MODE_PROP_COLOR_LSB          ) & Si2158B_ATV_VIDEO_MODE_PROP_COLOR_MASK;
               prop->atv_video_mode.invert_spectrum = (data >> Si2158B_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_LSB) & Si2158B_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_MASK;
     break;
    #endif /*     Si2158B_ATV_VIDEO_MODE_PROP */
    #ifdef        Si2158B_ATV_VSNR_CAP_PROP
     case         Si2158B_ATV_VSNR_CAP_PROP_CODE:
               prop->atv_vsnr_cap.atv_vsnr_cap = (data >> Si2158B_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_LSB) & Si2158B_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_MASK;
     break;
    #endif /*     Si2158B_ATV_VSNR_CAP_PROP */
    #ifdef        Si2158B_CRYSTAL_TRIM_PROP
     case         Si2158B_CRYSTAL_TRIM_PROP_CODE:
               prop->crystal_trim.xo_cap = (data >> Si2158B_CRYSTAL_TRIM_PROP_XO_CAP_LSB) & Si2158B_CRYSTAL_TRIM_PROP_XO_CAP_MASK;
     break;
    #endif /*     Si2158B_CRYSTAL_TRIM_PROP */
    #ifdef        Si2158B_DTV_AGC_AUTO_FREEZE_PROP
     case         Si2158B_DTV_AGC_AUTO_FREEZE_PROP_CODE:
               prop->dtv_agc_auto_freeze.thld    = (data >> Si2158B_DTV_AGC_AUTO_FREEZE_PROP_THLD_LSB   ) & Si2158B_DTV_AGC_AUTO_FREEZE_PROP_THLD_MASK;
               prop->dtv_agc_auto_freeze.timeout = (data >> Si2158B_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_LSB) & Si2158B_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_MASK;
     break;
    #endif /*     Si2158B_DTV_AGC_AUTO_FREEZE_PROP */
    #ifdef        Si2158B_DTV_AGC_FREEZE_INPUT_PROP
     case         Si2158B_DTV_AGC_FREEZE_INPUT_PROP_CODE:
               prop->dtv_agc_freeze_input.level = (data >> Si2158B_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_LSB) & Si2158B_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_MASK;
               prop->dtv_agc_freeze_input.pin   = (data >> Si2158B_DTV_AGC_FREEZE_INPUT_PROP_PIN_LSB  ) & Si2158B_DTV_AGC_FREEZE_INPUT_PROP_PIN_MASK;
     break;
    #endif /*     Si2158B_DTV_AGC_FREEZE_INPUT_PROP */
    #ifdef        Si2158B_DTV_AGC_SPEED_PROP
     case         Si2158B_DTV_AGC_SPEED_PROP_CODE:
               prop->dtv_agc_speed.if_agc_speed = (data >> Si2158B_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB) & Si2158B_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
               prop->dtv_agc_speed.agc_decim    = (data >> Si2158B_DTV_AGC_SPEED_PROP_AGC_DECIM_LSB   ) & Si2158B_DTV_AGC_SPEED_PROP_AGC_DECIM_MASK;
     break;
    #endif /*     Si2158B_DTV_AGC_SPEED_PROP */
    #ifdef        Si2158B_DTV_CONFIG_IF_PORT_PROP
     case         Si2158B_DTV_CONFIG_IF_PORT_PROP_CODE:
               prop->dtv_config_if_port.dtv_out_type   = (data >> Si2158B_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_LSB  ) & Si2158B_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_MASK;
               prop->dtv_config_if_port.dtv_agc_source = (data >> Si2158B_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_LSB) & Si2158B_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_MASK;
     break;
    #endif /*     Si2158B_DTV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2158B_DTV_EXT_AGC_PROP
     case         Si2158B_DTV_EXT_AGC_PROP_CODE:
               prop->dtv_ext_agc.min_10mv = (data >> Si2158B_DTV_EXT_AGC_PROP_MIN_10MV_LSB) & Si2158B_DTV_EXT_AGC_PROP_MIN_10MV_MASK;
               prop->dtv_ext_agc.max_10mv = (data >> Si2158B_DTV_EXT_AGC_PROP_MAX_10MV_LSB) & Si2158B_DTV_EXT_AGC_PROP_MAX_10MV_MASK;
     break;
    #endif /*     Si2158B_DTV_EXT_AGC_PROP */
    #ifdef        Si2158B_DTV_IEN_PROP
     case         Si2158B_DTV_IEN_PROP_CODE:
               prop->dtv_ien.chlien = (data >> Si2158B_DTV_IEN_PROP_CHLIEN_LSB) & Si2158B_DTV_IEN_PROP_CHLIEN_MASK;
     break;
    #endif /*     Si2158B_DTV_IEN_PROP */
    #ifdef        Si2158B_DTV_IF_AGC_SPEED_PROP
     case         Si2158B_DTV_IF_AGC_SPEED_PROP_CODE:
               prop->dtv_if_agc_speed.attack = (data >> Si2158B_DTV_IF_AGC_SPEED_PROP_ATTACK_LSB) & Si2158B_DTV_IF_AGC_SPEED_PROP_ATTACK_MASK;
               prop->dtv_if_agc_speed.decay  = (data >> Si2158B_DTV_IF_AGC_SPEED_PROP_DECAY_LSB ) & Si2158B_DTV_IF_AGC_SPEED_PROP_DECAY_MASK;
     break;
    #endif /*     Si2158B_DTV_IF_AGC_SPEED_PROP */
    #ifdef        Si2158B_DTV_INITIAL_AGC_SPEED_PROP
     case         Si2158B_DTV_INITIAL_AGC_SPEED_PROP_CODE:
               prop->dtv_initial_agc_speed.if_agc_speed = (data >> Si2158B_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_LSB) & Si2158B_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
               prop->dtv_initial_agc_speed.agc_decim    = (data >> Si2158B_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_LSB   ) & Si2158B_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_MASK;
     break;
    #endif /*     Si2158B_DTV_INITIAL_AGC_SPEED_PROP */
    #ifdef        Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP
     case         Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_CODE:
               prop->dtv_initial_agc_speed_period.period = (data >> Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_LSB) & Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_MASK;
     break;
    #endif /*     Si2158B_DTV_INITIAL_AGC_SPEED_PERIOD_PROP */
    #ifdef        Si2158B_DTV_INTERNAL_ZIF_PROP
     case         Si2158B_DTV_INTERNAL_ZIF_PROP_CODE:
               prop->dtv_internal_zif.atsc   = (data >> Si2158B_DTV_INTERNAL_ZIF_PROP_ATSC_LSB  ) & Si2158B_DTV_INTERNAL_ZIF_PROP_ATSC_MASK;
               prop->dtv_internal_zif.qam_us = (data >> Si2158B_DTV_INTERNAL_ZIF_PROP_QAM_US_LSB) & Si2158B_DTV_INTERNAL_ZIF_PROP_QAM_US_MASK;
               prop->dtv_internal_zif.dvbt   = (data >> Si2158B_DTV_INTERNAL_ZIF_PROP_DVBT_LSB  ) & Si2158B_DTV_INTERNAL_ZIF_PROP_DVBT_MASK;
               prop->dtv_internal_zif.dvbc   = (data >> Si2158B_DTV_INTERNAL_ZIF_PROP_DVBC_LSB  ) & Si2158B_DTV_INTERNAL_ZIF_PROP_DVBC_MASK;
               prop->dtv_internal_zif.isdbt  = (data >> Si2158B_DTV_INTERNAL_ZIF_PROP_ISDBT_LSB ) & Si2158B_DTV_INTERNAL_ZIF_PROP_ISDBT_MASK;
               prop->dtv_internal_zif.isdbc  = (data >> Si2158B_DTV_INTERNAL_ZIF_PROP_ISDBC_LSB ) & Si2158B_DTV_INTERNAL_ZIF_PROP_ISDBC_MASK;
               prop->dtv_internal_zif.dtmb   = (data >> Si2158B_DTV_INTERNAL_ZIF_PROP_DTMB_LSB  ) & Si2158B_DTV_INTERNAL_ZIF_PROP_DTMB_MASK;
     break;
    #endif /*     Si2158B_DTV_INTERNAL_ZIF_PROP */
    #ifdef        Si2158B_DTV_INT_SENSE_PROP
     case         Si2158B_DTV_INT_SENSE_PROP_CODE:
               prop->dtv_int_sense.chlnegen = (data >> Si2158B_DTV_INT_SENSE_PROP_CHLNEGEN_LSB) & Si2158B_DTV_INT_SENSE_PROP_CHLNEGEN_MASK;
               prop->dtv_int_sense.chlposen = (data >> Si2158B_DTV_INT_SENSE_PROP_CHLPOSEN_LSB) & Si2158B_DTV_INT_SENSE_PROP_CHLPOSEN_MASK;
     break;
    #endif /*     Si2158B_DTV_INT_SENSE_PROP */
    #ifdef        Si2158B_DTV_LIF_FREQ_PROP
     case         Si2158B_DTV_LIF_FREQ_PROP_CODE:
               prop->dtv_lif_freq.offset = (data >> Si2158B_DTV_LIF_FREQ_PROP_OFFSET_LSB) & Si2158B_DTV_LIF_FREQ_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2158B_DTV_LIF_FREQ_PROP */
    #ifdef        Si2158B_DTV_LIF_OUT_PROP
     case         Si2158B_DTV_LIF_OUT_PROP_CODE:
               prop->dtv_lif_out.offset = (data >> Si2158B_DTV_LIF_OUT_PROP_OFFSET_LSB) & Si2158B_DTV_LIF_OUT_PROP_OFFSET_MASK;
               prop->dtv_lif_out.amp    = (data >> Si2158B_DTV_LIF_OUT_PROP_AMP_LSB   ) & Si2158B_DTV_LIF_OUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2158B_DTV_LIF_OUT_PROP */
    #ifdef        Si2158B_DTV_MODE_PROP
     case         Si2158B_DTV_MODE_PROP_CODE:
               prop->dtv_mode.bw              = (data >> Si2158B_DTV_MODE_PROP_BW_LSB             ) & Si2158B_DTV_MODE_PROP_BW_MASK;
               prop->dtv_mode.modulation      = (data >> Si2158B_DTV_MODE_PROP_MODULATION_LSB     ) & Si2158B_DTV_MODE_PROP_MODULATION_MASK;
               prop->dtv_mode.invert_spectrum = (data >> Si2158B_DTV_MODE_PROP_INVERT_SPECTRUM_LSB) & Si2158B_DTV_MODE_PROP_INVERT_SPECTRUM_MASK;
     break;
    #endif /*     Si2158B_DTV_MODE_PROP */
    #ifdef        Si2158B_DTV_PGA_LIMITS_PROP
     case         Si2158B_DTV_PGA_LIMITS_PROP_CODE:
               prop->dtv_pga_limits.min = (data >> Si2158B_DTV_PGA_LIMITS_PROP_MIN_LSB) & Si2158B_DTV_PGA_LIMITS_PROP_MIN_MASK;
               prop->dtv_pga_limits.max = (data >> Si2158B_DTV_PGA_LIMITS_PROP_MAX_LSB) & Si2158B_DTV_PGA_LIMITS_PROP_MAX_MASK;
     break;
    #endif /*     Si2158B_DTV_PGA_LIMITS_PROP */
    #ifdef        Si2158B_DTV_PGA_TARGET_PROP
     case         Si2158B_DTV_PGA_TARGET_PROP_CODE:
               prop->dtv_pga_target.pga_target      = (data >> Si2158B_DTV_PGA_TARGET_PROP_PGA_TARGET_LSB     ) & Si2158B_DTV_PGA_TARGET_PROP_PGA_TARGET_MASK;
               prop->dtv_pga_target.override_enable = (data >> Si2158B_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB) & Si2158B_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK;
     break;
    #endif /*     Si2158B_DTV_PGA_TARGET_PROP */
    #ifdef        Si2158B_DTV_RF_AGC_SPEED_PROP
     case         Si2158B_DTV_RF_AGC_SPEED_PROP_CODE:
               prop->dtv_rf_agc_speed.attack = (data >> Si2158B_DTV_RF_AGC_SPEED_PROP_ATTACK_LSB) & Si2158B_DTV_RF_AGC_SPEED_PROP_ATTACK_MASK;
               prop->dtv_rf_agc_speed.decay  = (data >> Si2158B_DTV_RF_AGC_SPEED_PROP_DECAY_LSB ) & Si2158B_DTV_RF_AGC_SPEED_PROP_DECAY_MASK;
     break;
    #endif /*     Si2158B_DTV_RF_AGC_SPEED_PROP */
    #ifdef        Si2158B_DTV_RF_TOP_PROP
     case         Si2158B_DTV_RF_TOP_PROP_CODE:
               prop->dtv_rf_top.dtv_rf_top = (data >> Si2158B_DTV_RF_TOP_PROP_DTV_RF_TOP_LSB) & Si2158B_DTV_RF_TOP_PROP_DTV_RF_TOP_MASK;
     break;
    #endif /*     Si2158B_DTV_RF_TOP_PROP */
    #ifdef        Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_CODE:
               prop->dtv_rsq_rssi_threshold.lo = (data >> Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB) & Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK;
               prop->dtv_rsq_rssi_threshold.hi = (data >> Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB) & Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK;
     break;
    #endif /*     Si2158B_DTV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2158B_DTV_WB_AGC_SPEED_PROP
     case         Si2158B_DTV_WB_AGC_SPEED_PROP_CODE:
               prop->dtv_wb_agc_speed.attack = (data >> Si2158B_DTV_WB_AGC_SPEED_PROP_ATTACK_LSB) & Si2158B_DTV_WB_AGC_SPEED_PROP_ATTACK_MASK;
               prop->dtv_wb_agc_speed.decay  = (data >> Si2158B_DTV_WB_AGC_SPEED_PROP_DECAY_LSB ) & Si2158B_DTV_WB_AGC_SPEED_PROP_DECAY_MASK;
     break;
    #endif /*     Si2158B_DTV_WB_AGC_SPEED_PROP */
    #ifdef        Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP
     case         Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP_CODE:
               prop->dtv_zif_dc_canceller_bw.bandwidth = (data >> Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP_BANDWIDTH_LSB) & Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP_BANDWIDTH_MASK;
     break;
    #endif /*     Si2158B_DTV_ZIF_DC_CANCELLER_BW_PROP */
    #ifdef        Si2158B_MASTER_IEN_PROP
     case         Si2158B_MASTER_IEN_PROP_CODE:
               prop->master_ien.tunien = (data >> Si2158B_MASTER_IEN_PROP_TUNIEN_LSB) & Si2158B_MASTER_IEN_PROP_TUNIEN_MASK;
               prop->master_ien.atvien = (data >> Si2158B_MASTER_IEN_PROP_ATVIEN_LSB) & Si2158B_MASTER_IEN_PROP_ATVIEN_MASK;
               prop->master_ien.dtvien = (data >> Si2158B_MASTER_IEN_PROP_DTVIEN_LSB) & Si2158B_MASTER_IEN_PROP_DTVIEN_MASK;
               prop->master_ien.errien = (data >> Si2158B_MASTER_IEN_PROP_ERRIEN_LSB) & Si2158B_MASTER_IEN_PROP_ERRIEN_MASK;
               prop->master_ien.ctsien = (data >> Si2158B_MASTER_IEN_PROP_CTSIEN_LSB) & Si2158B_MASTER_IEN_PROP_CTSIEN_MASK;
     break;
    #endif /*     Si2158B_MASTER_IEN_PROP */
    #ifdef        Si2158B_TUNER_BLOCKED_VCO_PROP
     case         Si2158B_TUNER_BLOCKED_VCO_PROP_CODE:
               prop->tuner_blocked_vco.vco_code = (data >> Si2158B_TUNER_BLOCKED_VCO_PROP_VCO_CODE_LSB) & Si2158B_TUNER_BLOCKED_VCO_PROP_VCO_CODE_MASK;
     break;
    #endif /*     Si2158B_TUNER_BLOCKED_VCO_PROP */
    #ifdef        Si2158B_TUNER_IEN_PROP
     case         Si2158B_TUNER_IEN_PROP_CODE:
               prop->tuner_ien.tcien    = (data >> Si2158B_TUNER_IEN_PROP_TCIEN_LSB   ) & Si2158B_TUNER_IEN_PROP_TCIEN_MASK;
               prop->tuner_ien.rssilien = (data >> Si2158B_TUNER_IEN_PROP_RSSILIEN_LSB) & Si2158B_TUNER_IEN_PROP_RSSILIEN_MASK;
               prop->tuner_ien.rssihien = (data >> Si2158B_TUNER_IEN_PROP_RSSIHIEN_LSB) & Si2158B_TUNER_IEN_PROP_RSSIHIEN_MASK;
     break;
    #endif /*     Si2158B_TUNER_IEN_PROP */
    #ifdef        Si2158B_TUNER_INT_SENSE_PROP
     case         Si2158B_TUNER_INT_SENSE_PROP_CODE:
               prop->tuner_int_sense.tcnegen    = (data >> Si2158B_TUNER_INT_SENSE_PROP_TCNEGEN_LSB   ) & Si2158B_TUNER_INT_SENSE_PROP_TCNEGEN_MASK;
               prop->tuner_int_sense.rssilnegen = (data >> Si2158B_TUNER_INT_SENSE_PROP_RSSILNEGEN_LSB) & Si2158B_TUNER_INT_SENSE_PROP_RSSILNEGEN_MASK;
               prop->tuner_int_sense.rssihnegen = (data >> Si2158B_TUNER_INT_SENSE_PROP_RSSIHNEGEN_LSB) & Si2158B_TUNER_INT_SENSE_PROP_RSSIHNEGEN_MASK;
               prop->tuner_int_sense.tcposen    = (data >> Si2158B_TUNER_INT_SENSE_PROP_TCPOSEN_LSB   ) & Si2158B_TUNER_INT_SENSE_PROP_TCPOSEN_MASK;
               prop->tuner_int_sense.rssilposen = (data >> Si2158B_TUNER_INT_SENSE_PROP_RSSILPOSEN_LSB) & Si2158B_TUNER_INT_SENSE_PROP_RSSILPOSEN_MASK;
               prop->tuner_int_sense.rssihposen = (data >> Si2158B_TUNER_INT_SENSE_PROP_RSSIHPOSEN_LSB) & Si2158B_TUNER_INT_SENSE_PROP_RSSIHPOSEN_MASK;
     break;
    #endif /*     Si2158B_TUNER_INT_SENSE_PROP */
    #ifdef        Si2158B_TUNER_LO_INJECTION_PROP
     case         Si2158B_TUNER_LO_INJECTION_PROP_CODE:
               prop->tuner_lo_injection.band_1 = (data >> Si2158B_TUNER_LO_INJECTION_PROP_BAND_1_LSB) & Si2158B_TUNER_LO_INJECTION_PROP_BAND_1_MASK;
               prop->tuner_lo_injection.band_2 = (data >> Si2158B_TUNER_LO_INJECTION_PROP_BAND_2_LSB) & Si2158B_TUNER_LO_INJECTION_PROP_BAND_2_MASK;
               prop->tuner_lo_injection.band_3 = (data >> Si2158B_TUNER_LO_INJECTION_PROP_BAND_3_LSB) & Si2158B_TUNER_LO_INJECTION_PROP_BAND_3_MASK;
     break;
    #endif /*     Si2158B_TUNER_LO_INJECTION_PROP */
    #ifdef        Si2158B_TUNER_RETURN_LOSS_PROP
     case         Si2158B_TUNER_RETURN_LOSS_PROP_CODE:
               prop->tuner_return_loss.config = (data >> Si2158B_TUNER_RETURN_LOSS_PROP_CONFIG_LSB) & Si2158B_TUNER_RETURN_LOSS_PROP_CONFIG_MASK;
               prop->tuner_return_loss.mode   = (data >> Si2158B_TUNER_RETURN_LOSS_PROP_MODE_LSB  ) & Si2158B_TUNER_RETURN_LOSS_PROP_MODE_MASK;
     break;
    #endif /*     Si2158B_TUNER_RETURN_LOSS_PROP */
    #ifdef        Si2158B_XOUT_PROP
     case         Si2158B_XOUT_PROP_CODE:
               prop->xout.amp = (data >> Si2158B_XOUT_PROP_AMP_LSB) & Si2158B_XOUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2158B_XOUT_PROP */
     default : return ERROR_Si2158B_UNKNOWN_PROPERTY; break;
    }
...
/***********************************************************************************************************************
  Si2158B_storePropertiesDefaults function
  Use:        property defaults function
              Used to fill the propShadow structure with startup values.
  Parameter: *prop     the Si2158B_PropObject structure
...
void          Si2158B_storePropertiesDefaults(Si2158B_PropObj   *prop) {
  SiTRACE("Si2158B_storePropertiesDefaults\n");
#ifdef    Si2158B_ATV_AFC_RANGE_PROP
...
/***********************************************************************************************************************
  Si2158B_L1_PropertyText function
  Use:        property text function
              Used to turn the property data into clear text.
  Parameter: *prop     the Si2158B property structure (containing all properties)
  ...
  Returns:    NO_Si2158B_ERROR if successful.
 ***********************************************************************************************************************/
unsigned char Si2158B_L1_PropertyText          (Si2158B_PropObj   *prop, unsigned int prop_code, const char *separator, char *msg) {
    switch (prop_code) {
    #ifdef        Si2158B_ATV_AFC_RANGE_PROP
     case         Si2158B_ATV_AFC_RANGE_PROP_CODE:
     ...
     case         Si2158B_DTV_RF_AGC_SPEED_PROP_CODE:
      ...
      else                                             sprintf(msg,"%s%d", prop->dtv_rf_agc_speed.attack);
       strcat(msg,separator); strcat(msg,"-DECAY ");
           if  (prop->dtv_rf_agc_speed.decay  ==     0) strcat(msg,"AUTO ");
      else                                             sprintf(msg,"%s%d", prop->dtv_rf_agc_speed.decay);
     break;
    #endif /*     Si2158B_DTV_RF_AGC_SPEED_PROP */
    #ifdef        Si2158B_DTV_RF_TOP_PROP
     case         Si2158B_DTV_RF_TOP_PROP_CODE:
     ...
     break;
    #endif /*     Si2158B_XOUT_PROP */
     default : sprintf(msg,"Unknown property code '0x%06x'\n", prop_code); return ERROR_Si2158B_UNKNOWN_PROPERTY; break;
    }
  return NO_Si2158B_ERROR;
}
/***********************************************************************************************************************
  Si2158B_L1_FillPropertyStringText function
...
void          Si2158B_L1_FillPropertyStringText(L1_Si2158B_Context *api, unsigned int prop_code, const char *separator, char *msg) {
  Si2158B_L1_PropertyText (api->prop, prop_code, separator, msg);
}
/***********************************************************************************************************************
  Si2158B_L1_GetPropertyString function
  ...
  Returns:    NO_Si2158B_ERROR if successful.
 ***********************************************************************************************************************/
unsigned char Si2158B_L1_GetPropertyString     (L1_Si2158B_Context *api, unsigned int prop_code, const char *separator, char *msg) {
    int res;
    res = Si2158B_L1_GetProperty2(api,prop_code);
    if (res!=NO_Si2158B_ERROR) { sprintf(msg, "%s",Si2158B_L1_API_ERROR_TEXT(res)); return res; }
    Si2158B_L1_PropertyText(api->prop, prop_code, separator, msg);
    return NO_Si2158B_ERROR;
  }
