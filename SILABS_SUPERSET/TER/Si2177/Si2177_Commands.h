...
/*************************************************************************************
   ...
   FILE: Si2177_Commands.h
   Supported IC : Si2177
   Compiled for ROM 50 firmware 3_1_build_3
   Revision: 0.1
   Date: June 30 2015
**************************************************************************************/
#ifndef    Si2177_COMMANDS_H
#define    Si2177_COMMANDS_H
...
#define   Si2177_AGC_OVERRIDE_CMD 0x44
  ...
  #define Si2177_AGC_OVERRIDE_CMD_CODE 0x010044
...
#define   Si2177_ATV_RESTART_CMD 0x51
  ...
  #define Si2177_ATV_RESTART_CMD_CODE 0x010051
...
#define   Si2177_ATV_STATUS_CMD 0x52
  ...
  #define Si2177_ATV_STATUS_CMD_CODE 0x010052
...
#define   Si2177_CONFIG_PINS_CMD 0x12
  ...
  #define Si2177_CONFIG_PINS_CMD_CODE 0x010012
...
#define   Si2177_DTV_RESTART_CMD 0x61
  ...
  #define Si2177_DTV_RESTART_CMD_CODE 0x010061

    typedef struct { /* Si2177_DTV_RESTART_CMD_struct */
         unsigned char   nothing;   } Si2177_DTV_RESTART_CMD_struct;
...
#define   Si2177_DTV_STATUS_CMD 0x62
  ...
  #define Si2177_DTV_STATUS_CMD_CODE 0x010062
   ...
   #define  Si2177_DTV_STATUS_RESPONSE_BW_MASK        0x0f
    #define Si2177_DTV_STATUS_RESPONSE_BW_BW_1P7MHZ  9
    #define Si2177_DTV_STATUS_RESPONSE_BW_BW_6MHZ    6
    #define Si2177_DTV_STATUS_RESPONSE_BW_BW_6P1MHZ  10
...
#define   Si2177_EXIT_BOOTLOADER_CMD 0x01
  ...
  #define Si2177_EXIT_BOOTLOADER_CMD_CODE 0x010001
...
#define   Si2177_FINE_TUNE_CMD 0x45
  ...
  #define Si2177_FINE_TUNE_CMD_CODE 0x010045
...
#define   Si2177_GET_PROPERTY_CMD 0x15
  ...
  #define Si2177_GET_PROPERTY_CMD_CODE 0x010015
...
#define   Si2177_GET_REV_CMD 0x11
  ...
  #define Si2177_GET_REV_CMD_CODE 0x010011

    typedef struct { /* Si2177_GET_REV_CMD_struct */
         unsigned char   nothing;   } Si2177_GET_REV_CMD_struct;
...
#define   Si2177_PART_INFO_CMD 0x02
  ...
  #define Si2177_PART_INFO_CMD_CODE 0x010002

    typedef struct { /* Si2177_PART_INFO_CMD_struct */
         unsigned char   nothing;   } Si2177_PART_INFO_CMD_struct;
...
#define   Si2177_POWER_DOWN_CMD 0x13
  ...
  #define Si2177_POWER_DOWN_CMD_CODE 0x010013

    typedef struct { /* Si2177_POWER_DOWN_CMD_struct */
         unsigned char   nothing;   } Si2177_POWER_DOWN_CMD_struct;
...
#define   Si2177_POWER_DOWN_HW_CMD 0xc0
  ...
  #define Si2177_POWER_DOWN_HW_CMD_CODE 0x0300c0
...
#define   Si2177_POWER_UP_CMD 0xc0
  ...
  #define Si2177_POWER_UP_CMD_CODE 0x0400c0
...
#define   Si2177_SET_PROPERTY_CMD 0x14
  ...
  #define Si2177_SET_PROPERTY_CMD_CODE 0x010014
...
#define   Si2177_STANDBY_CMD 0x16
  ...
  #define Si2177_STANDBY_CMD_CODE 0x010016
...
#define   Si2177_TUNER_STATUS_CMD 0x42
  ...
  #define Si2177_TUNER_STATUS_CMD_CODE 0x010042
...
#define   Si2177_TUNER_TUNE_FREQ_CMD 0x41
  ...
  #define Si2177_TUNER_TUNE_FREQ_CMD_CODE 0x010041
  ...
  /* --------------------------------------------*/
  typedef struct { /* Si2177_CmdObj struct */
    #ifdef    Si2177_AGC_OVERRIDE_CMD
  ...
  typedef struct { /* Si2177_CmdReplyObj struct */
    ...
    #endif /* Si2177_CONFIG_CLOCKS_CMD */
    #ifdef    Si2177_CONFIG_I2C_CMD
              Si2177_CONFIG_I2C_CMD_REPLY_struct       config_i2c;
    #endif /* Si2177_CONFIG_I2C_CMD */
    #ifdef    Si2177_CONFIG_PINS_CMD
              Si2177_CONFIG_PINS_CMD_REPLY_struct      config_pins;
    #endif /* Si2177_CONFIG_PINS_CMD */
    #ifdef    Si2177_DTV_RESTART_CMD
              Si2177_DTV_RESTART_CMD_REPLY_struct      dtv_restart;
    #endif /* Si2177_DTV_RESTART_CMD */
    #ifdef    Si2177_DTV_STATUS_CMD
              Si2177_DTV_STATUS_CMD_REPLY_struct       dtv_status;
    #endif /* Si2177_DTV_STATUS_CMD */
    #ifdef    Si2177_EXIT_BOOTLOADER_CMD
...
#ifdef    Si2177_COMMAND_PROTOTYPES
#define   Si2177_GET_COMMAND_STRINGS
#endif /* Si2177_COMMAND_PROTOTYPES */

#endif /* Si2177_COMMANDS_H */
