...
#define   Si2141_DTV_RF_TOP_PROP 0x0709
  ...
  #define Si2141_DTV_RF_TOP_PROP_CODE 0x000709
   ...
   #define  Si2141_DTV_RF_TOP_PROP_DTV_RF_TOP_DEFAULT    0
    ...
    #define Si2141_DTV_RF_TOP_PROP_DTV_RF_TOP_P7DB     7
    #define Si2141_DTV_RF_TOP_PROP_DTV_RF_TOP_P6P5DB   8
...
/* Si2141 WIDE_BAND_ATT_THRS property definition */
#define   Si2141_WIDE_BAND_ATT_THRS_PROP 0x0503

#ifdef    Si2141_WIDE_BAND_ATT_THRS_PROP
  #define Si2141_WIDE_BAND_ATT_THRS_PROP_CODE 0x000503


    typedef struct { /* Si2141_WIDE_BAND_ATT_THRS_PROP_struct */
      unsigned char   wb_att_thrs;
   } Si2141_WIDE_BAND_ATT_THRS_PROP_struct;

   /* WIDE_BAND_ATT_THRS property, WB_ATT_THRS field definition (NO TITLE)*/
   #define  Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_LSB         0
   #define  Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_MASK        0xff
   #define  Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_DEFAULT    0
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_AUTO     0
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P6DBM    6
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P5DBM    7
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P4DBM    8
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P3DBM    9
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P2DBM    10
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P1DBM    11
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_0DBM     12
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M1DBM    13
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M2DBM    14
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M3DBM    15
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M4DBM    16
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M5DBM    17
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M6DBM    18
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M7DBM    19
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M8DBM    20
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M9DBM    21
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M10DBM   22
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M11DBM   23
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M12DBM   24
    #define Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_DISABLE  255
...
#define   Si2141_XOUT_PROP 0x0404
  ...
  typedef struct {
    ...
    #endif /* Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP */
    #ifdef    Si2141_WIDE_BAND_ATT_THRS_PROP
              Si2141_WIDE_BAND_ATT_THRS_PROP_struct            wide_band_att_thrs;
    #endif /* Si2141_WIDE_BAND_ATT_THRS_PROP */
    #ifdef    Si2141_XOUT_PROP
