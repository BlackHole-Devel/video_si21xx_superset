...
int  Si2141_downloadTUNERProperties       (L1_Si2141_Context *api) {
  ...
  if (Si2141_L1_SetProperty2(api, Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP_CODE   ) != NO_Si2141_ERROR) {return ERROR_Si2141_SENDING_COMMAND;}
#endif /* Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP */
#ifdef    Si2141_WIDE_BAND_ATT_THRS_PROP
  if (Si2141_L1_SetProperty2(api, Si2141_WIDE_BAND_ATT_THRS_PROP_CODE          ) != NO_Si2141_ERROR) {return ERROR_Si2141_SENDING_COMMAND;}
...
unsigned char Si2141_PackProperty            (Si2141_PropObj   *prop, unsigned int prop_code, int *data) {
    ...
    #endif /*     Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP */
    #ifdef        Si2141_WIDE_BAND_ATT_THRS_PROP
     case         Si2141_WIDE_BAND_ATT_THRS_PROP_CODE:
      *data = (prop->wide_band_att_thrs.wb_att_thrs & Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_MASK) << Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_LSB ;
     break;
    #endif /*     Si2141_WIDE_BAND_ATT_THRS_PROP */
    #ifdef        Si2141_XOUT_PROP
...
unsigned char Si2141_UnpackProperty          (Si2141_PropObj   *prop, unsigned int prop_code, int  data) {
    ...
    #ifdef        Si2141_WIDE_BAND_ATT_THRS_PROP
     case         Si2141_WIDE_BAND_ATT_THRS_PROP_CODE:
               prop->wide_band_att_thrs.wb_att_thrs = (data >> Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_LSB) & Si2141_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_MASK;
     break;
    #endif /*     Si2141_WIDE_BAND_ATT_THRS_PROP */
    #ifdef        Si2141_XOUT_PROP
     case         Si2141_XOUT_PROP_CODE:
