...
int  Si2157_downloadDTVProperties         (L1_Si2157_Context *api) {
  ...
  if (Si2157_L1_SetProperty2(api, Si2157_DTV_AGC_AUTO_FREEZE_PROP_CODE         ) != NO_Si2157_ERROR) {return ERROR_Si2157_SENDING_COMMAND;}
  ...
  if (Si2157_L1_SetProperty2(api, Si2157_DTV_IF_AGC_SPEED_PROP_CODE            ) != NO_Si2157_ERROR) {return ERROR_Si2157_SENDING_COMMAND;}
  ...
  if (Si2157_L1_SetProperty2(api, Si2157_DTV_RF_AGC_SPEED_PROP_CODE            ) != NO_Si2157_ERROR) {return ERROR_Si2157_SENDING_COMMAND;}
  ...
  if (Si2157_L1_SetProperty2(api, Si2157_DTV_WB_AGC_SPEED_PROP_CODE            ) != NO_Si2157_ERROR) {return ERROR_Si2157_SENDING_COMMAND;}
...
unsigned char Si2157_PackProperty            (Si2157_PropObj   *prop, unsigned int prop_code, int *data) {
    ...
    #endif /*     Si2157_CRYSTAL_TRIM_PROP */
    #ifdef        Si2157_DTV_AGC_AUTO_FREEZE_PROP
     case         Si2157_DTV_AGC_AUTO_FREEZE_PROP_CODE:
      *data = (prop->dtv_agc_auto_freeze.thld    & Si2157_DTV_AGC_AUTO_FREEZE_PROP_THLD_MASK   ) << Si2157_DTV_AGC_AUTO_FREEZE_PROP_THLD_LSB  |
              (prop->dtv_agc_auto_freeze.timeout & Si2157_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_MASK) << Si2157_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_LSB ;
     break;
    #endif /*     Si2157_DTV_AGC_AUTO_FREEZE_PROP */
    #ifdef        Si2157_DTV_AGC_FREEZE_INPUT_PROP
    ...
    #endif /*     Si2157_DTV_IEN_PROP */
    #ifdef        Si2157_DTV_IF_AGC_SPEED_PROP
     case         Si2157_DTV_IF_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_if_agc_speed.attack & Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_MASK) << Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_LSB  |
              (prop->dtv_if_agc_speed.decay  & Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_MASK ) << Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_LSB ;
     break;
    #endif /*     Si2157_DTV_IF_AGC_SPEED_PROP */
    #ifdef        Si2157_DTV_INITIAL_AGC_SPEED_PROP
    ...
    #endif /*     Si2157_DTV_PGA_TARGET_PROP */
    #ifdef        Si2157_DTV_RF_AGC_SPEED_PROP
     case         Si2157_DTV_RF_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_rf_agc_speed.attack & Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_MASK) << Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_LSB  |
              (prop->dtv_rf_agc_speed.decay  & Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_MASK ) << Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_LSB ;
     break;
    #endif /*     Si2157_DTV_RF_AGC_SPEED_PROP */
    #ifdef        Si2157_DTV_RF_TOP_PROP
    ...
    #endif /*     Si2157_DTV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2157_DTV_WB_AGC_SPEED_PROP
     case         Si2157_DTV_WB_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_wb_agc_speed.attack & Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_MASK) << Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_LSB  |
              (prop->dtv_wb_agc_speed.decay  & Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_MASK ) << Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_LSB ;
     break;
    #endif /*     Si2157_DTV_WB_AGC_SPEED_PROP */
    #ifdef        Si2157_DTV_ZIF_DC_CANCELLER_BW_PROP
...
unsigned char Si2157_UnpackProperty          (Si2157_PropObj   *prop, unsigned int prop_code, int  data) {
    ...
    #ifdef        Si2157_DTV_AGC_AUTO_FREEZE_PROP
     case         Si2157_DTV_AGC_AUTO_FREEZE_PROP_CODE:
               prop->dtv_agc_auto_freeze.thld    = (data >> Si2157_DTV_AGC_AUTO_FREEZE_PROP_THLD_LSB   ) & Si2157_DTV_AGC_AUTO_FREEZE_PROP_THLD_MASK;
               prop->dtv_agc_auto_freeze.timeout = (data >> Si2157_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_LSB) & Si2157_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_MASK;
     break;
    #endif /*     Si2157_DTV_AGC_AUTO_FREEZE_PROP */
    #ifdef        Si2157_DTV_AGC_FREEZE_INPUT_PROP
     case         Si2157_DTV_AGC_FREEZE_INPUT_PROP_CODE:
    ...
    #ifdef        Si2157_DTV_IF_AGC_SPEED_PROP
     case         Si2157_DTV_IF_AGC_SPEED_PROP_CODE:
               prop->dtv_if_agc_speed.attack = (data >> Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_LSB) & Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_MASK;
               prop->dtv_if_agc_speed.decay  = (data >> Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_LSB ) & Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_MASK;
     break;
    #endif /*     Si2157_DTV_IF_AGC_SPEED_PROP */
    #ifdef        Si2157_DTV_INITIAL_AGC_SPEED_PROP
     case         Si2157_DTV_INITIAL_AGC_SPEED_PROP_CODE:
    ...
    #ifdef        Si2157_DTV_RF_AGC_SPEED_PROP
     case         Si2157_DTV_RF_AGC_SPEED_PROP_CODE:
               prop->dtv_rf_agc_speed.attack = (data >> Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_LSB) & Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_MASK;
               prop->dtv_rf_agc_speed.decay  = (data >> Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_LSB ) & Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_MASK;
     break;
    #endif /*     Si2157_DTV_RF_AGC_SPEED_PROP */
    #ifdef        Si2157_DTV_RF_TOP_PROP
     case         Si2157_DTV_RF_TOP_PROP_CODE:
    ...
    #ifdef        Si2157_DTV_WB_AGC_SPEED_PROP
     case         Si2157_DTV_WB_AGC_SPEED_PROP_CODE:
               prop->dtv_wb_agc_speed.attack = (data >> Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_LSB) & Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_MASK;
               prop->dtv_wb_agc_speed.decay  = (data >> Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_LSB ) & Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_MASK;
     break;
    #endif /*     Si2157_DTV_WB_AGC_SPEED_PROP */
    #ifdef        Si2157_DTV_ZIF_DC_CANCELLER_BW_PROP
     case         Si2157_DTV_ZIF_DC_CANCELLER_BW_PROP_CODE:
...
void          Si2157_storePropertiesDefaults(Si2157_PropObj   *prop) {
...
#ifdef    Si2157_DTV_IF_AGC_SPEED_PROP
  prop->dtv_if_agc_speed.attack              = Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_AUTO ; /* (default 'AUTO') */
  prop->dtv_if_agc_speed.decay               = Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_AUTO  ; /* (default 'AUTO') */
#endif /* Si2157_DTV_IF_AGC_SPEED_PROP */
  ...
  prop->dtv_internal_zif.dtmb                = Si2157_DTV_INTERNAL_ZIF_PROP_DTMB_LIF   ; /* (default 'LIF') */
#endif /* Si2157_DTV_INTERNAL_ZIF_PROP */
...
#ifdef    Si2157_DTV_RF_AGC_SPEED_PROP
  prop->dtv_rf_agc_speed.attack              = Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_AUTO ; /* (default 'AUTO') */
  prop->dtv_rf_agc_speed.decay               = Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_AUTO  ; /* (default 'AUTO') */
#endif /* Si2157_DTV_RF_AGC_SPEED_PROP */
...
#ifdef    Si2157_DTV_WB_AGC_SPEED_PROP
  prop->dtv_wb_agc_speed.attack              = Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_AUTO ; /* (default 'AUTO') */
  prop->dtv_wb_agc_speed.decay               = Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_AUTO  ; /* (default 'AUTO') */
#endif /* Si2157_DTV_WB_AGC_SPEED_PROP */
