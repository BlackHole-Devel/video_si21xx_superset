...
L1_Si2157_Context         *tuners[FRONT_END_COUNT];
...
int  main(int argc, char *argv[]) {
    ...
    int tuner_addr[] = {Si2157_BASE_ADDRESS,0xc2};
 ...
 /* If using 2 tuners (or more) startup both tuners using CONFIG_I2C command to broadcast firmware download */
      ...
      if (Si2157_PowerUpUsingBroadcastI2C(tuners,FRONT_END_COUNT) != NO_Si2157_ERROR )
      {
        SiTRACE("\n");
        SiTRACE("ERROR ----------------------------------\n");
