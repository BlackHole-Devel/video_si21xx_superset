...
/* Si2157 DTV_AGC_AUTO_FREEZE property definition */
#define   Si2157_DTV_AGC_AUTO_FREEZE_PROP 0x0714

#ifdef    Si2157_DTV_AGC_AUTO_FREEZE_PROP
  #define Si2157_DTV_AGC_AUTO_FREEZE_PROP_CODE 0x000714


    typedef struct { /* Si2157_DTV_AGC_AUTO_FREEZE_PROP_struct */
      unsigned char   thld;
      unsigned char   timeout;
   } Si2157_DTV_AGC_AUTO_FREEZE_PROP_struct;

   /* DTV_AGC_AUTO_FREEZE property, THLD field definition (NO TITLE)*/
   #define  Si2157_DTV_AGC_AUTO_FREEZE_PROP_THLD_LSB         0
   #define  Si2157_DTV_AGC_AUTO_FREEZE_PROP_THLD_MASK        0xff
   #define  Si2157_DTV_AGC_AUTO_FREEZE_PROP_THLD_DEFAULT    255
    #define Si2157_DTV_AGC_AUTO_FREEZE_PROP_THLD_THLD_MIN  0
    #define Si2157_DTV_AGC_AUTO_FREEZE_PROP_THLD_THLD_MAX  255

   /* DTV_AGC_AUTO_FREEZE property, TIMEOUT field definition (NO TITLE)*/
   #define  Si2157_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_LSB         8
   #define  Si2157_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_MASK        0xff
   #define  Si2157_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_DEFAULT    1
    #define Si2157_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_TIMEOUT_MIN  1
    #define Si2157_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_TIMEOUT_MAX  250

#endif /* Si2157_DTV_AGC_AUTO_FREEZE_PROP */
...
/* Si2157 DTV_IF_AGC_SPEED property definition */
#define   Si2157_DTV_IF_AGC_SPEED_PROP 0x0716

#ifdef    Si2157_DTV_IF_AGC_SPEED_PROP
  #define Si2157_DTV_IF_AGC_SPEED_PROP_CODE 0x000716


    typedef struct { /* Si2157_DTV_IF_AGC_SPEED_PROP_struct */
      unsigned char   attack;
      unsigned char   decay;
   } Si2157_DTV_IF_AGC_SPEED_PROP_struct;

   /* DTV_IF_AGC_SPEED property, ATTACK field definition (NO TITLE)*/
   #define  Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_LSB         0
   #define  Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_MASK        0xff
   #define  Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_DEFAULT    0
    #define Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_AUTO  0

    #define Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_ATTACK_MIN  0
    #define Si2157_DTV_IF_AGC_SPEED_PROP_ATTACK_ATTACK_MAX  231

   /* DTV_IF_AGC_SPEED property, DECAY field definition (NO TITLE)*/
   #define  Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_LSB         8
   #define  Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_MASK        0xff
   #define  Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_DEFAULT    0
    #define Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_AUTO  0

    #define Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_DECAY_MIN  0
    #define Si2157_DTV_IF_AGC_SPEED_PROP_DECAY_DECAY_MAX  231

#endif /* Si2157_DTV_IF_AGC_SPEED_PROP */
...
#define   Si2157_DTV_INTERNAL_ZIF_PROP 0x0710
  ...
  #define Si2157_DTV_INTERNAL_ZIF_PROP_CODE 0x000710
   ...
   #define  Si2157_DTV_INTERNAL_ZIF_PROP_DTMB_DEFAULT    0
...
/* Si2157 DTV_RF_AGC_SPEED property definition */
#define   Si2157_DTV_RF_AGC_SPEED_PROP 0x0715

#ifdef    Si2157_DTV_RF_AGC_SPEED_PROP
  #define Si2157_DTV_RF_AGC_SPEED_PROP_CODE 0x000715


    typedef struct { /* Si2157_DTV_RF_AGC_SPEED_PROP_struct */
      unsigned char   attack;
      unsigned char   decay;
   } Si2157_DTV_RF_AGC_SPEED_PROP_struct;

   /* DTV_RF_AGC_SPEED property, ATTACK field definition (NO TITLE)*/
   #define  Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_LSB         0
   #define  Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_MASK        0xff
   #define  Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_DEFAULT    0
    #define Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_AUTO  0

    #define Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_ATTACK_MIN  0
    #define Si2157_DTV_RF_AGC_SPEED_PROP_ATTACK_ATTACK_MAX  231

   /* DTV_RF_AGC_SPEED property, DECAY field definition (NO TITLE)*/
   #define  Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_LSB         8
   #define  Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_MASK        0xff
   #define  Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_DEFAULT    0
    #define Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_AUTO  0

    #define Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_DECAY_MIN  0
    #define Si2157_DTV_RF_AGC_SPEED_PROP_DECAY_DECAY_MAX  231

#endif /* Si2157_DTV_RF_AGC_SPEED_PROP */
...
/* Si2157 DTV_WB_AGC_SPEED property definition */
#define   Si2157_DTV_WB_AGC_SPEED_PROP 0x0717

#ifdef    Si2157_DTV_WB_AGC_SPEED_PROP
  #define Si2157_DTV_WB_AGC_SPEED_PROP_CODE 0x000717


    typedef struct { /* Si2157_DTV_WB_AGC_SPEED_PROP_struct */
      unsigned char   attack;
      unsigned char   decay;
   } Si2157_DTV_WB_AGC_SPEED_PROP_struct;

   /* DTV_WB_AGC_SPEED property, ATTACK field definition (NO TITLE)*/
   #define  Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_LSB         0
   #define  Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_MASK        0xff
   #define  Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_DEFAULT    0
    #define Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_AUTO  0

    #define Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_ATTACK_MIN  0
    #define Si2157_DTV_WB_AGC_SPEED_PROP_ATTACK_ATTACK_MAX  231

   /* DTV_WB_AGC_SPEED property, DECAY field definition (NO TITLE)*/
   #define  Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_LSB         8
   #define  Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_MASK        0xff
   #define  Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_DEFAULT    0
    #define Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_AUTO  0

    #define Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_DECAY_MIN  0
    #define Si2157_DTV_WB_AGC_SPEED_PROP_DECAY_DECAY_MAX  231

#endif /* Si2157_DTV_WB_AGC_SPEED_PROP */
...
#define   Si2157_XOUT_PROP 0x0404
  ...
  typedef struct {
    ...
    #endif /* Si2157_CRYSTAL_TRIM_PROP */
    #ifdef    Si2157_DTV_AGC_AUTO_FREEZE_PROP
              Si2157_DTV_AGC_AUTO_FREEZE_PROP_struct           dtv_agc_auto_freeze;
    #endif /* Si2157_DTV_AGC_AUTO_FREEZE_PROP */
    #ifdef    Si2157_DTV_AGC_FREEZE_INPUT_PROP
    ...
    #endif /* Si2157_DTV_IEN_PROP */
    #ifdef    Si2157_DTV_IF_AGC_SPEED_PROP
              Si2157_DTV_IF_AGC_SPEED_PROP_struct              dtv_if_agc_speed;
    #endif /* Si2157_DTV_IF_AGC_SPEED_PROP */
    #ifdef    Si2157_DTV_INITIAL_AGC_SPEED_PROP
    ...
    #endif /* Si2157_DTV_PGA_TARGET_PROP */
    #ifdef    Si2157_DTV_RF_AGC_SPEED_PROP
              Si2157_DTV_RF_AGC_SPEED_PROP_struct              dtv_rf_agc_speed;
    #endif /* Si2157_DTV_RF_AGC_SPEED_PROP */
    #ifdef    Si2157_DTV_RF_TOP_PROP
    ...
    #endif /* Si2157_DTV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef    Si2157_DTV_WB_AGC_SPEED_PROP
              Si2157_DTV_WB_AGC_SPEED_PROP_struct              dtv_wb_agc_speed;
    #endif /* Si2157_DTV_WB_AGC_SPEED_PROP */
    #ifdef    Si2157_DTV_ZIF_DC_CANCELLER_BW_PROP
