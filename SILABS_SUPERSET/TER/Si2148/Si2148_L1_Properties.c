...
unsigned char Si2148_L1_SetProperty2(L1_Si2148_Context *api, unsigned int prop_code) {
    ...
    switch (prop_code) {
     ...
     case         Si2148_DTV_RF_AGC_SPEED_PROP_CODE:
      data = (api->prop->dtv_rf_agc_speed.attack & Si2148_DTV_RF_AGC_SPEED_PROP_ATTACK_MASK) << Si2148_DTV_RF_AGC_SPEED_PROP_ATTACK_LSB  |
              (api->prop->dtv_rf_agc_speed.decay  & Si2148_DTV_RF_AGC_SPEED_PROP_DECAY_MASK ) << Si2148_DTV_RF_AGC_SPEED_PROP_DECAY_LSB ;
     break;
     ...
     case         Si2148_XOUT_PROP_CODE:
       data = (api->prop->xout.amp & Si2148_XOUT_PROP_AMP_MASK) << Si2148_XOUT_PROP_AMP_LSB ;
     break;
...
unsigned char Si2148_L1_GetProperty2(L1_Si2148_Context *api, unsigned int prop_code) {
    ...
    #ifdef        Si2148_XOUT_PROP
     case         Si2148_XOUT_PROP_CODE:
               api->prop->xout.amp = (data >> Si2148_XOUT_PROP_AMP_LSB) & Si2148_XOUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2148_XOUT_PROP */
   default : break;
    }
