...
unsigned char Si2148_L1_SetProperty        (L1_Si2148_Context *api, unsigned int prop_code, int  data);
unsigned char Si2148_L1_GetProperty        (L1_Si2148_Context *api, unsigned int prop_code, int *data);
