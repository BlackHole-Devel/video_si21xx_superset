...
/* Si2148 DTV_RF_AGC_SPEED property definition */
#define   Si2148_DTV_RF_AGC_SPEED_PROP 0x0715

#ifdef    Si2148_DTV_RF_AGC_SPEED_PROP
  #define Si2148_DTV_RF_AGC_SPEED_PROP_CODE 0x000715


    typedef struct { /* Si2148_DTV_RF_AGC_SPEED_PROP_struct */
      unsigned char   attack;
      unsigned char   decay;
   } Si2148_DTV_RF_AGC_SPEED_PROP_struct;

   /* DTV_RF_AGC_SPEED property, ATTACK field definition (NO TITLE)*/
   #define  Si2148_DTV_RF_AGC_SPEED_PROP_ATTACK_LSB         0
   #define  Si2148_DTV_RF_AGC_SPEED_PROP_ATTACK_MASK        0xff
   #define  Si2148_DTV_RF_AGC_SPEED_PROP_ATTACK_DEFAULT    0
    #define Si2148_DTV_RF_AGC_SPEED_PROP_ATTACK_ATTACK_MIN  0
    #define Si2148_DTV_RF_AGC_SPEED_PROP_ATTACK_ATTACK_MAX  231

   /* DTV_RF_AGC_SPEED property, DECAY field definition (NO TITLE)*/
   #define  Si2148_DTV_RF_AGC_SPEED_PROP_DECAY_LSB         8
   #define  Si2148_DTV_RF_AGC_SPEED_PROP_DECAY_MASK        0xff
   #define  Si2148_DTV_RF_AGC_SPEED_PROP_DECAY_DEFAULT    0
    #define Si2148_DTV_RF_AGC_SPEED_PROP_DECAY_DECAY_MIN  0
    #define Si2148_DTV_RF_AGC_SPEED_PROP_DECAY_DECAY_MAX  231

#endif /* Si2148_DTV_RF_AGC_SPEED_PROP */
...
/* Si2148 XOUT property definition */
#define   Si2148_XOUT_PROP 0x0404

#ifdef    Si2148_XOUT_PROP
  #define Si2148_XOUT_PROP_CODE 0x000404


    typedef struct { /* Si2148_XOUT_PROP_struct */
      unsigned char   amp;
   } Si2148_XOUT_PROP_struct;

   /* XOUT property, AMP field definition (NO TITLE)*/
   #define  Si2148_XOUT_PROP_AMP_LSB         0
   #define  Si2148_XOUT_PROP_AMP_MASK        0x01
   #define  Si2148_XOUT_PROP_AMP_DEFAULT    0
    #define Si2148_XOUT_PROP_AMP_HIGH  0
    #define Si2148_XOUT_PROP_AMP_LOW   1
  ...
  typedef struct {
    ...
    #endif /* Si2148_DTV_PGA_TARGET_PROP */
    #ifdef    Si2148_DTV_RF_AGC_SPEED_PROP
              Si2148_DTV_RF_AGC_SPEED_PROP_struct              dtv_rf_agc_speed;
    #endif /* Si2148_DTV_RF_AGC_SPEED_PROP */
    #ifdef    Si2148_DTV_RF_TOP_PROP
