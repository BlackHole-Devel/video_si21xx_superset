...
/*************************************************************************************
   ...
   FILE: Si2178B_typedefs.h
   Supported IC : Si2178B
   Compiled for ROM 51 firmware 4_1_build_3
   Revision: 0.1
   Date: September 09 2015
**************************************************************************************/
#ifndef   Si2178B_TYPEDEFS_H
#define   Si2178B_TYPEDEFS_H
...
#define Si2178B_BROADCAST_ADDRESS 0xc4

typedef struct L1_Si2178B_Context {
  L0_Context                 *i2c;
  L0_Context                  i2cObj;
  Si2178B_CmdObj              *cmd;
  Si2178B_CmdObj               cmdObj;
  Si2178B_CmdReplyObj         *rsp;
  Si2178B_CmdReplyObj          rspObj;
  Si2178B_PropObj             *prop;
  Si2178B_PropObj              propObj;
  Si2178B_PropObj             *propShadow;
  Si2178B_PropObj              propShadowObj;
  Si2178B_COMMON_REPLY_struct *status;
  Si2178B_COMMON_REPLY_struct  statusObj;
