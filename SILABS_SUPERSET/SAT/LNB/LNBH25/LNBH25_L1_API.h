 ...
 *************************************************************************************************************/
#ifndef   LNBH25_L1_API_H
#define   LNBH25_L1_API_H

#include "Silabs_L0_API.h"

typedef struct LNBH25_Context {
  L0_Context    *i2c;
  L0_Context     i2cObj;
...
#define LNBH25_SUPPLY_OFF 0
#define LNBH25_SUPPLY_ON  1

#define LNBH25_HORIZONTAL 0
#define LNBH25_VERTICAL   1

#define LNBH25_DISEQC_MODE_22_KHZ     0
#define LNBH25_DISEQC_MODE_ENVELOPE   1

#ifdef RWTRACES
    #define LNBH25_WRITE(register,v)    L0_WriteRegisterTrace         (context->i2c, #register, #v, register##_ADDRESS, register##_OFFSET, register##_NBBIT, register##_ALONE, v)
    #define LNBH25_READ(register,v)     L0_ReadRegisterTrace          (context->i2c, #register, #v, register##_ADDRESS, register##_OFFSET, register##_NBBIT)
#else
    #define LNBH25_WRITE(register, v )  L0_WriteRegister              (context->i2c,                register##_ADDRESS, register##_OFFSET, register##_NBBIT, register##_ALONE, v)
    #define LNBH25_READ(register,v)     L0_ReadRegister               (context->i2c,                register##_ADDRESS, register##_OFFSET, register##_NBBIT)
#endif

  #ifdef    Layer1_LNBH25

#define   LNBH25_setup_registers
#ifdef    LNBH25_setup_registers
 /* vout                           (0002h) */
...
#endif /* LNBH25_setup_registers */

#define   LNBH25_status_registers
#ifdef    LNBH25_status_registers
...
char *L1_LNBH25_TAG_Text       (void);

#endif /* LNBH25_L1_API_H */
